...
def rrb430Eff():
    ...
    if SLOT_ReturnVal:
        _gotolabel(1)
    sprite('rrb430_14', 5)	# 29-33
    GFX_0('rrbCaseEffC', 0)
    gotoLabel(2)
    label(1)
    sprite('rrb430_14', 5)	# 34-38
    GFX_0('rrbCaseEffD', 0)
    label(2)
    sprite('null', 4)	# 39-42
    GFX_0('rrb430eEff', 0)
    ...
    if SLOT_ReturnVal:
        _gotolabel(3)
    sprite('rrb430_19', 3)	# 43-45
    GFX_0('rrbCaseEff', 0)
    gotoLabel(0)
    label(3)
    sprite('rrb430_19', 3)	# 46-48
    GFX_0('rrbCaseEffB', 0)
    gotoLabel(0)
    label(10)
    sprite('null', 3)	# 49-51
    sprite('rrb430_17', 2)	# 52-53
    GFX_0('rrbCaseEffB', 0)
    sprite('null', 200)	# 54-253
    Unknown26('rrb430eEff')
    GFX_0('rrb430fEff', 0)
    label(20)
    sprite('null', 60)	# 254-313
    GFX_0('rrb430MuzzleEff_03', 0)
    GFX_0('rrb430Ryuhai', 103)
    GFX_0('rrb430FinishHit', 103)
    sprite('null', 1)	# 314-314
    Unknown14()
    label(100)
    sprite('rrb430_17', 3)	# 315-317
    sprite('rrb430_17', 6)	# 318-323
    GFX_0('rrbCaseEffB', 0)
    Unknown26('rrb430eEff')
...
def rrb430EffOD():
    ...
    if SLOT_ReturnVal:
        _gotolabel(5)
    sprite('rrb430_14', 5)	# 51-55
    GFX_0('rrbCaseEffC', 0)
    gotoLabel(6)
    label(5)
    sprite('rrb430_14', 5)	# 56-60
    GFX_0('rrbCaseEffD', 0)
    label(6)
    sprite('null', 4)	# 61-64
    GFX_0('rrb430eEffB', 0)
    ...
    if SLOT_ReturnVal:
        _gotolabel(7)
    sprite('rrb430_19', 3)	# 65-67
    GFX_0('rrbCaseEff', 0)
    gotoLabel(0)
    label(7)
    sprite('rrb430_19', 3)	# 68-70
    GFX_0('rrbCaseEffB', 0)
    gotoLabel(0)
    label(10)
    sprite('null', 3)	# 71-73
    sprite('rrb430_17', 4)	# 74-77
    GFX_0('rrbCaseEffB', 0)
    sprite('null', 200)	# 78-277
    Unknown26('rrb430eEff')
    GFX_0('rrb430fEff', 0)
    label(20)
    sprite('null', 60)	# 278-337
    GFX_0('rrb430MuzzleEff_03', 0)
    GFX_0('rrb430Ryuhai', 103)
    GFX_0('rrb430FinishHit', 103)
    sprite('null', 1)	# 338-338
    Unknown14()
    label(100)
    sprite('rrb430_17', 10)	# 339-348
    GFX_0('rrbCaseEffB', 0)
    Unknown26('rrb430eEff')
    GFX_0('rrb430fEff', 100)
