...
def Vat_187_1():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown9266(14)
        Unknown4011(3)
    sprite('Action_187_00', 5)	# 1-5
    GFX_0('Vat_186_1', -1)
    sprite('Action_187_01', 5)	# 6-10
    sprite('Action_187_02', 10)	# 11-20
    SFX_3('SE_SwingLightSword')
    sprite('Action_187_03', 10)	# 21-30	 **attackbox here**
    sprite('Action_187_04', 10)	# 31-40
    sprite('Action_187_05', 10)	# 41-50
    sprite('Action_187_06', 1)	# 51-51
    sprite('Action_187_07', 1)	# 52-52
...
def Vat_186_1():
    ...
    sprite('Action_186_13', 2)	# 31-32	 **attackbox here**
    sprite('Action_186_14', 2)	# 33-34	 **attackbox here**
    sprite('Action_186_07', 2)	# 35-36	 **attackbox here**
    sprite('Action_186_08', 2)	# 37-38	 **attackbox here**
    sprite('Action_186_09', 2)	# 39-40	 **attackbox here**
    sprite('Action_186_10', 2)	# 41-42	 **attackbox here**
    sprite('Action_186_11', 2)	# 43-44	 **attackbox here**
    sprite('Action_186_15', 5)	# 45-49	 **attackbox here**
    sprite('Action_186_16', 5)	# 50-54	 **attackbox here**
    sprite('Action_186_17', 5)	# 55-59	 **attackbox here**
    sprite('Action_186_18', 5)	# 60-64	 **attackbox here**
    sprite('Action_186_19', 3)	# 65-67	 **attackbox here**
    sprite('Action_186_20', 3)	# 68-70
...
def Vat_193():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_17():
            sendToLabel(20)
    sprite('Action_193_00', 3)	# 1-3
    sprite('Action_193_01', 3)	# 4-6
    sprite('Action_193_02', 3)	# 7-9
    sprite('Action_193_03', 3)	# 10-12
    Unknown1019(80)
    YAccel(80)
    sprite('Action_193_04', 3)	# 13-15
    Unknown1019(30)
    YAccel(60)
    sprite('Action_193_05', 3)	# 16-18
    Unknown1019(5)
    YAccel(5)
    sprite('Action_193_06', 2)	# 19-20
    Unknown1084(1)
    sprite('Action_193_07', 2)	# 21-22
    sprite('Action_193_08', 2)	# 23-24
    sprite('Action_193_09', 2)	# 25-26
    sprite('Action_193_10', 2)	# 27-28
    sprite('Action_193_11', 2)	# 29-30
    sprite('Action_193_12', 2)	# 31-32
    sprite('Action_193_13', 2)	# 33-34
    sprite('Action_193_14', 2)	# 35-36
    label(0)
    sprite('Action_193_06', 2)	# 37-38
    sprite('Action_193_07', 2)	# 39-40
    sprite('Action_193_08', 2)	# 41-42
    sprite('Action_193_09', 2)	# 43-44
    sprite('Action_193_10', 2)	# 45-46
    sprite('Action_193_11', 2)	# 47-48
    sprite('Action_193_12', 2)	# 49-50
    sprite('Action_193_13', 2)	# 51-52
    sprite('Action_193_14', 2)	# 53-54
    gotoLabel(0)
    label(10)
    sprite('Action_193_15', 5)	# 55-59
    GFX_0('Vat_178', -1)
    sprite('Action_193_16', 5)	# 60-64
    sprite('Action_193_17', 5)	# 65-69
    sprite('Action_193_18', 5)	# 70-74
    ExitState()
    label(20)
    sprite('Action_193_15', 5)	# 75-79
    clearUponHandler(44)
    clearUponHandler(43)
    clearUponHandler(17)
    clearUponHandler(53)
    sprite('Action_193_16', 5)	# 80-84
    sprite('Action_193_17', 5)	# 85-89
    sprite('Action_193_18', 5)	# 90-94
...
def Vat_178():
    ...
    def upon_IMMEDIATE():
        ...
        MinimumDamagePct(10)
        Unknown30065(0)
    sprite('Action_178_00', 2)	# 1-2
    ScreenShake(8000, 8000)
    sprite('Action_178_01', 2)	# 3-4	 **attackbox here**
    sprite('Action_178_02', 2)	# 5-6	 **attackbox here**
    sprite('Action_178_03', 2)	# 7-8	 **attackbox here**
    RefreshMultihit()
    sprite('Action_178_04', 2)	# 9-10	 **attackbox here**
    sprite('Action_178_05', 2)	# 11-12	 **attackbox here**
    RefreshMultihit()
    sprite('Action_178_06', 2)	# 13-14	 **attackbox here**
    sprite('Action_178_07', 2)	# 15-16	 **attackbox here**
    RefreshMultihit()
    sprite('Action_178_08', 2)	# 17-18	 **attackbox here**
    sprite('Action_178_09', 3)	# 19-21
    sprite('Action_178_10', 3)	# 22-24	 **attackbox here**
    RefreshMultihit()
    sprite('Action_178_11', 3)	# 25-27	 **attackbox here**
    RefreshMultihit()
    Damage(1000)
    AirUntechableTime(90)
    AirPushbackX(2000)
    ...
    AirHitstunAnimation(9)
    Unknown11001(0, 0, 0)
    sprite('Action_178_12', 3)	# 28-30
    sprite('Action_178_13', 3)	# 31-33
    sprite('Action_178_14', 3)	# 34-36
    sprite('Action_178_15', 3)	# 37-39
