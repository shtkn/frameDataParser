...
def PBC_ReceptionSignal():
    ...
    def upon_43():
        ...
        if (SLOT_48 == 1001):
            Unknown23185('5042435f506572736f6e61456e747279535000000000000000000000000000002c010000')
        if (SLOT_48 == 9999):
...
def PBC_Persona5D():
        ...
        def upon_CLEAR_OR_EXIT():
            if SLOT_2:
                if (SLOT_19 < 350000):
                    sendToLabel(0)
        Unknown23059(1)
    sprite('iz205_00', 1)	# 1-1
    Unknown2006()
    sprite('iz205_01', 1)	# 2-2
    sprite('iz205_02', 1)	# 3-3
    Unknown4007(0)
    sprite('iz205_03', 1)	# 4-4
    ScreenShake(20000, 0)
    sprite('iz205_04', 1)	# 5-5
    sprite('iz205_05', 1)	# 6-6
    physicsXImpulse(20000)
    sprite('iz205_06', 1)	# 7-7
    Unknown1019(150)
    SFX_3('slash_blade_slow')
    sprite('iz205_07', 3)	# 8-10	 **attackbox here**
    GFX_1('izef_groundzan_04', 0)
    Unknown1019(150)
    Unknown2037(1)
    sprite('iz205_08', 3)	# 11-13	 **attackbox here**
    GFX_1('izef_groundzan_04', 0)
    sprite('iz205_07', 3)	# 14-16	 **attackbox here**
    GFX_1('izef_groundzan_04', 0)
    sprite('iz205_08', 3)	# 17-19	 **attackbox here**
    GFX_1('izef_groundzan_04', 0)
    label(0)
    sprite('keep', 4)	# 20-23
    clearUponHandler(3)
    Unknown1019(50)
    RefreshMultihit()
    sprite('iz205_10', 3)	# 24-26	 **attackbox here**
    GFX_0('TsukiZanzoh5D', 100)
    Unknown38(4, 1)
    RefreshMultihit()
    Unknown23029(2, 12, 0)
    Unknown23078(1)
    sprite('iz205_11', 3)	# 27-29
    Unknown1019(50)
    DisableAttackRestOfMove()
    sprite('iz205_12', 3)	# 30-32
    Unknown1019(50)
    sprite('iz205_10', 3)	# 33-35	 **attackbox here**
    Unknown1019(0)
    sprite('iz205_11', 3)	# 36-38
    sprite('iz205_12', 3)	# 39-41
    sprite('iz205_10', 4)	# 42-45	 **attackbox here**
    sprite('iz205_11', 4)	# 46-49
    sprite('iz205_12', 4)	# 50-53
    label(580)
...
def bcef_433card_finish():
    ...
    def PBC_PersonaEntrySP():
        ...
        sprite('iz600_01', 6)	# 43-48
        label(0)
        sprite('iz600_03', 6)	# 49-54
        sprite('iz600_04', 6)	# 55-60
        sprite('iz600_05', 6)	# 61-66
        gotoLabel(0)
