...
def PAG_Persona5C():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown23059(1)
    sprite('at204_01', 3)	# 1-3
    Unknown2006()
    sprite('at204_02', 2)	# 4-5
    sprite('at204_03', 2)	# 6-7
    sprite('at204_04', 2)	# 8-9	 **attackbox here**
    RefreshMultihit()
    GFX_0('Zanzoh5C', 100)
    SFX_3('slash_pole_slow')
    sprite('at204_05', 3)	# 10-12
    sprite('at204_06', 3)	# 13-15
    DisableAttackRestOfMove()
    sprite('at204_07', 3)	# 16-18
    sprite('at204_08', 3)	# 19-21
    sprite('at204_09', 3)	# 22-24
    sprite('at204_07', 3)	# 25-27
    sprite('at204_08', 3)	# 28-30
    sprite('at204_09', 3)	# 31-33
    sprite('keep', 32767)	# 34-32800
...
def Persona5B_2nd():
    ...
    def upon_IMMEDIATE():
        ...
        callSubroutine('PAG_CheckWarp')
        Unknown23059(1)
    sprite('at205_03', 1)	# 1-1
    Unknown2006()
    sprite('at206_00', 1)	# 2-2
    sprite('at206_05', 1)	# 3-3
    sprite('at206_06', 1)	# 4-4
    sprite('at206_07', 1)	# 5-5
    sprite('at206_08', 4)	# 6-9	 **attackbox here**
    GFX_0('DBarrierAtk', 0)
    RefreshMultihit()
    physicsXImpulse(60000)
    SFX_3('ag006')
    EnableCollision(0)
    sprite('at206_09', 4)	# 10-13	 **attackbox here**
    SFX_3('airdash_m')
    sprite('at206_08', 4)	# 14-17	 **attackbox here**
    sprite('at206_09', 4)	# 18-21	 **attackbox here**
    Unknown1019(70)
    sprite('at206_10', 4)	# 22-25
    Unknown1019(70)
    Unknown26('DBarrierAtk')
    sprite('at206_11', 4)	# 26-29
    Unknown1019(70)
    sprite('at206_12', 4)	# 30-33
    Unknown1019(0)
    sprite('at206_13', 4)	# 34-37
    sprite('at206_14', 4)	# 38-41
...
def PAG_PersonaAir5C():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            ...
            if (SLOT_48 == 1022):
                Unknown26('ZanzohAir5C')
                sendToLabel(0)
    sprite('at254_00', 2)	# 1-2
    sprite('at254_01', 2)	# 3-4
    sprite('at254_03', 4)	# 5-8	 **attackbox here**
    Unknown23054('61743235345f303200000000000000000000000000000000000000000000000002000000')
    sprite('at254_03', 2)	# 9-10	 **attackbox here**
    DisableAttackRestOfMove()
    sprite('at254_04', 4)	# 11-14
    sprite('at254_05', 2)	# 15-16
    GFX_0('ZanzohAir5C', 100)
    sprite('at254_06', 3)	# 17-19	 **attackbox here**
    RefreshMultihit()
    Unknown9071()
    AirPushbackY(37000)
    ...
    Unknown9016(1)
    SFX_3('slash_pole_slow')
    sprite('at254_07', 3)	# 20-22	 **attackbox here**
    sprite('at254_08', 3)	# 23-25	 **attackbox here**
    DisableAttackRestOfMove()
    sprite('at254_09', 3)	# 26-28	 **attackbox here**
    label(0)
...
def PAG_PersonaAir5D():
    ...
    def upon_IMMEDIATE():
        ...
        sendToLabelUpon(2, 9)
        Unknown23059(1)
    sprite('at256_00', 2)	# 1-2
    physicsXImpulse(-2000)
    physicsYImpulse(40000)
    SFX_3('highjump_m')
    sprite('at256_01', 2)	# 3-4
    Unknown1084(1)
    sprite('at256_02', 2)	# 5-6
    sprite('at256_03', 2)	# 7-8
    SFX_3('slash_rapier_slow')
    sprite('at256_04', 3)	# 9-11	 **attackbox here**
    physicsXImpulse(24000)
    physicsYImpulse(-40000)
    RefreshMultihit()
    sprite('at256_05', 3)	# 12-14	 **attackbox here**
    label(0)
    sprite('at256_04', 3)	# 15-17	 **attackbox here**
    sprite('at256_05', 3)	# 18-20	 **attackbox here**
    loopRest()
    gotoLabel(0)
    label(9)
    sprite('keep', 1)	# 21-21
    ...
    SFX_3('guard_hit_m')
    Unknown8003(100, 1, 1)
    sprite('at256_06', 3)	# 22-24
    sprite('at256_07', 3)	# 25-27
    sprite('at256_08', 3)	# 28-30
    sprite('at256_09', 3)	# 31-33
    sprite('at256_10', 3)	# 34-36
    sprite('at256_08', 3)	# 37-39
    sprite('at256_09', 3)	# 40-42
    sprite('at256_10', 3)	# 43-45
    label(10)
...
def PAG_PersonaRolling():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_77():
            ...
            EnableCollision(0)
            Unknown35()
    sprite('at409_00', 3)	# 1-3
    GFX_0('AtenaFlameEX', 0)
    physicsYImpulse(25000)
    sprite('at409_01', 2)	# 4-5
    sprite('at409_02', 2)	# 6-7
    sprite('at409_03', 2)	# 8-9
    sprite('at409_04', 3)	# 10-12
    sprite('at409_05', 2)	# 13-14	 **attackbox here**
    RefreshMultihit()
    clearUponHandler(3)
    sprite('at409_06', 2)	# 15-16	 **attackbox here**
    Unknown1019(30)
    YAccel(30)
    sprite('at409_07', 3)	# 17-19	 **attackbox here**
    Unknown1019(50)
    YAccel(50)
    sprite('at409_08', 6)	# 20-25	 **attackbox here**
    Unknown1084(1)
    label(0)
    sprite('at409_09', 3)	# 26-28	 **attackbox here**
    RefreshMultihit()
    ...
    AirPushbackY(2500)
    YImpluseBeforeWallbounce(800)
    sprite('at409_10', 3)	# 29-31	 **attackbox here**
    RefreshMultihit()
    sprite('at409_11', 2)	# 32-33	 **attackbox here**
    RefreshMultihit()
    sprite('at409_11', 1)	# 34-34	 **attackbox here**
    if SLOT_2:
        Unknown2038(-1)
        sendToLabel(0)
    else:
    ...
    gotoLabel(0)
    label(1)
    sprite('at409_09', 3)	# 35-37	 **attackbox here**
    GFX_0('AtenaFlameA', 0)
    RefreshMultihit()
    AirPushbackY(10000)
    ...
    Unknown35()
    clearUponHandler(77)
    sprite('at409_12', 4)	# 38-41
    sprite('at409_16', 3)	# 42-44
    sprite('at409_17', 3)	# 45-47
    sprite('at409_18', 3)	# 48-50	 **attackbox here**
    RefreshMultihit()
    Damage(1000)
    AirPushbackX(10000)
    AirPushbackY(-40000)
    ...
    Unknown11064(0)
    SLOT_10 = 0
    sprite('at409_19', 3)	# 51-53
    GFX_0('AtenaFlameBex', 0)
    physicsXImpulse(-16000)
    physicsYImpulse(40000)
    sprite('at409_20', 3)	# 54-56
    Unknown1019(15)
    YAccel(15)
    sprite('at409_21', 3)	# 57-59
    Unknown1019(80)
    YAccel(80)
    sprite('at409_19', 3)	# 60-62
    Unknown1019(80)
    YAccel(80)
    sprite('at409_20', 3)	# 63-65
    Unknown1019(80)
    YAccel(80)
    sprite('at409_21', 3)	# 66-68
    Unknown1019(60)
    YAccel(60)
    sprite('at409_19', 3)	# 69-71
    Unknown1019(60)
    YAccel(60)
    sprite('at409_20', 3)	# 72-74
    Unknown1019(0)
    YAccel(0)
    sprite('at409_21', 3)	# 75-77
    sprite('at409_19', 3)	# 78-80
    sprite('at409_20', 3)	# 81-83
    sprite('at409_21', 3)	# 84-86
...
def PAG_PersonaRollingEX():
    ...
    clearUponHandler(77)
    sprite('at409_12', 4)	# 38-41
    sprite('at409_13', 3)	# 42-44
    sprite('at409_14', 3)	# 45-47
    sprite('at409_15', 3)	# 48-50
    sprite('at409_16', 3)	# 51-53
    sprite('at409_17', 3)	# 54-56
    sprite('at409_18', 3)	# 57-59	 **attackbox here**
    RefreshMultihit()
    Damage(2000)
    AirPushbackX(10000)
    AirPushbackY(-40000)
    ...
    YAccel(0)
    sprite('at409_21', 3)	# 84-86
    sprite('at409_19', 3)	# 87-89
    sprite('at409_20', 3)	# 90-92
    sprite('at409_21', 3)	# 93-95
...
def PAG_PersonaAthenaSurfing():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown11058('0000000001000000000000000000000000000000')
        Unknown11084(1)
    sprite('at430_02', 2)	# 1-2
    Unknown2053(0)
    sprite('at430_00', 2)	# 3-4
    sprite('at430_01', 2)	# 5-6
    sprite('at430_02', 2)	# 7-8
    sprite('at430_00', 2)	# 9-10
    sprite('at430_01', 2)	# 11-12
    sprite('at430_02', 2)	# 13-14
    sprite('at430_00', 2)	# 15-16
    sprite('at430_01', 2)	# 17-18
    sprite('at430_02', 2)	# 19-20
    sprite('at430_00', 2)	# 21-22
    sprite('at430_01', 2)	# 23-24
    sprite('at430_02', 2)	# 25-26
    GFX_0('BarrierEnagy', 0)
    GFX_0('BarrierEyeFire', 1)
    sprite('at430_03', 2)	# 27-28
    sprite('at430_04', 2)	# 29-30
    sprite('at430_05', 4)	# 31-34
    sprite('at430_06', 4)	# 35-38
    sprite('at430_07', 4)	# 39-42
    sprite('at430_08', 4)	# 43-46
    sprite('at430_09', 4)	# 47-50
    sprite('at430_07', 4)	# 51-54
    sprite('at430_08', 4)	# 55-58
    sprite('at430_09', 4)	# 59-62
    sprite('at430_10', 4)	# 63-66
    GFX_0('eyeHikari', 0)
    GFX_0('eyeHikari', 1)
    sprite('at430_11', 4)	# 67-70	 **attackbox here**
    GFX_0('BarrierDashEyeFire', 0)
    GFX_0('SurfingBarrierAtk', 1)
    RefreshMultihit()
    physicsXImpulse(5000)
    Unknown1028(4500)
    sprite('at430_12', 4)	# 71-74	 **attackbox here**
    GuardPoint_(1)
    sprite('at430_11', 4)	# 75-78	 **attackbox here**
    sprite('at430_12', 4)	# 79-82	 **attackbox here**
    sprite('at430_11', 4)	# 83-86	 **attackbox here**
    sprite('at430_12', 4)	# 87-90	 **attackbox here**
    sprite('at430_11', 4)	# 91-94	 **attackbox here**
    setInvincible(0)
    Unknown2003(1)
    Unknown23022(1)
    sprite('at430_12', 4)	# 95-98	 **attackbox here**
    sprite('at206_11', 4)	# 99-102
    sprite('at206_12', 4)	# 103-106
    sprite('at206_11', 4)	# 107-110
    sprite('at206_12', 4)	# 111-114
    sprite('at206_13', 4)	# 115-118
    sprite('at206_14', 4)	# 119-122
...
def PAG_UltimateSpear():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_17():
            ...
            Unknown51(0)
        Unknown23059(1)
    sprite('at206_12', 2)	# 1-2
    physicsXImpulse(50000)
    sprite('at206_13', 3)	# 3-5
    Unknown1019(50)
    sprite('at206_14', 3)	# 6-8
    Unknown1019(50)
    sprite('at431_00', 3)	# 9-11
    GFX_0('throwEnagytame', 0)
    Unknown1019(50)
    sprite('at431_01', 4)	# 12-15
    Unknown1084(1)
    sprite('at431_02', 4)	# 16-19
    sprite('at431_00', 4)	# 20-23
    sprite('at431_01', 4)	# 24-27
    sprite('at431_02', 4)	# 28-31
    sprite('at431_00', 4)	# 32-35
    sprite('at431_01', 4)	# 36-39
    sprite('at431_02', 4)	# 40-43
    sprite('at431_00', 4)	# 44-47
    sprite('at431_01', 4)	# 48-51
    sprite('at431_02', 2)	# 52-53
    SFX_3('slash_blade_middle')
    sprite('at431_03', 2)	# 54-55
    Unknown26('throwEnagytame')
    sprite('at431_04', 2)	# 56-57
    sprite('at431_05', 2)	# 58-59
    sprite('at431_06ex01', 4)	# 60-63
    GFX_0('throwGroundShock', 1)
    GFX_0('AddSpear', 100)
    sprite('at431_07', 4)	# 64-67
    sprite('at431_08', 4)	# 68-71
    setInvincible(0)
    sprite('at431_09', 4)	# 72-75
    sprite('at431_07', 4)	# 76-79
    sprite('at431_08', 4)	# 80-83
    sprite('at431_09', 4)	# 84-87
    sprite('at431_07', 4)	# 88-91
    sprite('at431_08', 4)	# 92-95
    sprite('at431_09', 4)	# 96-99
...
def PAG_Spear():
    ...
    def upon_IMMEDIATE():
        ...
        callSubroutine('PAG_ForceWarp')
        callSubroutine('Init_CantCancelPersonaAction')
    sprite('at431_00', 4)	# 1-4
    SFX_3('slash_blade_middle')
    sprite('at431_03', 2)	# 5-6
    sprite('at431_04', 2)	# 7-8
    sprite('at431_05', 2)	# 9-10
    sprite('at431_06ex01', 4)	# 11-14
    GFX_0('Spear_Reversal', 100)
    Unknown4007(0)
    sprite('at431_07', 4)	# 15-18
    sprite('at431_08', 4)	# 19-22
    setInvincible(0)
    sprite('at431_09', 4)	# 23-26
    sprite('at431_07', 4)	# 27-30
    sprite('at431_08', 4)	# 31-34
    sprite('at431_09', 4)	# 35-38
    sprite('at431_07', 4)	# 39-42
    sprite('at431_08', 4)	# 43-46
    sprite('at431_09', 4)	# 47-50
    sprite('at431_07', 4)	# 51-54
    sprite('at431_08', 4)	# 55-58
    sprite('at431_09', 4)	# 59-62
    sprite('at431_07', 4)	# 63-66
    sprite('at431_08', 4)	# 67-70
    sprite('at431_09', 4)	# 71-74
...
def PAG_Persona2C_TAG():
    ...
    def upon_IMMEDIATE():
        ...
        callSubroutine('PAG_CheckWarp')
        Unknown23059(1)
    sprite('at254_04', 2)	# 1-2
    physicsXImpulse(40000)
    sprite('at254_05', 2)	# 3-4
    Unknown4007(0)
    GFX_0('Zanzoh2C', 100)
    Unknown1019(50)
    sprite('at254_06ex', 3)	# 5-7	 **attackbox here**
    RefreshMultihit()
    SFX_3('slash_pole_slow')
    Unknown1019(50)
    sprite('at254_07', 3)	# 8-10	 **attackbox here**
    Unknown1019(50)
    sprite('at254_08', 3)	# 11-13	 **attackbox here**
    Unknown1019(0)
    DisableAttackRestOfMove()
    sprite('at254_09', 3)	# 14-16	 **attackbox here**
    sprite('at254_07', 3)	# 17-19	 **attackbox here**
    sprite('at254_08', 3)	# 20-22	 **attackbox here**
    sprite('at254_09', 3)	# 23-25	 **attackbox here**
    sprite('at254_07', 3)	# 26-28	 **attackbox here**
    sprite('at254_08', 3)	# 29-31	 **attackbox here**
    sprite('at254_09', 3)	# 32-34	 **attackbox here**
...
def PAG_Persona5D_TAG():
    ...
    sprite('at206_05', 3)	# 1-3
    sprite('at206_06', 3)	# 4-6
    sprite('at206_07', 3)	# 7-9
    sprite('at206_08', 2)	# 10-11	 **attackbox here**
    GFX_0('DBarrierAtk', 0)
    DisableAttackRestOfMove()
    physicsXImpulse(60000)
    SFX_3('ag006')
    sprite('at206_08', 1)	# 12-12	 **attackbox here**
    RefreshMultihit()
    sprite('at206_09', 3)	# 13-15	 **attackbox here**
    SFX_3('airdash_m')
    physicsXImpulse(0)
    Unknown4007(3)
    sprite('at206_08', 3)	# 16-18	 **attackbox here**
    sprite('at206_09', 3)	# 19-21	 **attackbox here**
    sprite('at206_10', 5)	# 22-26
    Unknown1019(40)
    EnableCollision(0)
    Unknown26('DBarrierAtk')
    Unknown26('DBarrierAtkShock')
    sprite('at206_11', 5)	# 27-31
    Unknown1019(40)
    Unknown4007(0)
    sprite('at206_12', 3)	# 32-34
    Unknown1019(40)
    sprite('at206_13', 3)	# 35-37
    Unknown1019(40)
    sprite('at206_14', 3)	# 38-40
    Unknown1019(40)
    sprite('at206_12', 3)	# 41-43
    Unknown1019(40)
    sprite('at206_13', 3)	# 44-46
    Unknown1019(40)
    sprite('at206_14', 3)	# 47-49
    Unknown1019(0)
    sprite('at206_12', 3)	# 50-52
    sprite('at206_13', 3)	# 53-55
...
def PAG_PersonaIchigeki():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown2054(1)
        Unknown23022(1)
    sprite('at450_00', 3)	# 1-3
    Unknown2036(44, -1, 0)
    sprite('at450_01', 3)	# 4-6
    sprite('at450_02', 3)	# 7-9
    sprite('at450_00', 3)	# 10-12
    sprite('at450_01', 3)	# 13-15
    sprite('at450_02', 3)	# 16-18
    sprite('at450_00', 3)	# 19-21
    sprite('at450_01', 3)	# 22-24
    sprite('at450_02', 3)	# 25-27
    sprite('at450_03', 2)	# 28-29
    sprite('at450_04', 2)	# 30-31
    sprite('at450_05', 2)	# 32-33
    sprite('at450_06', 2)	# 34-35
    SFX_3('slash_blade_middle')
    sprite('at450_07', 2)	# 36-37
    sprite('at450_08', 2)	# 38-39
    sprite('at450_09', 2)	# 40-41
    GFX_0('IchigekiSpear', 0)
    Unknown38(5, 1)
    sprite('at450_10', 3)	# 42-44	 **attackbox here**
    sprite('at450_11', 3)	# 45-47
    sprite('at450_12', 3)	# 48-50
...
def Zanzoh2C():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3032()
        Unknown4061(1)
    sprite('vr_at254_00', 3)	# 1-3
    sprite('vr_at254_01', 27)	# 4-30
    Unknown3004(-30)
...
def ZanzohAir5C():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3032()
        Unknown4061(1)
    sprite('vr_at254_00', 2)	# 1-2
    sprite('vr_at254_01', 16)	# 3-18
    Unknown3004(-26)
...
def Throw_bom():
    ...
    sprite('throw_bom', 40)	# 1-40	 **attackbox here**
    GFX_0('Throw_bom_blink', 100)
    StartMultihit()
    sprite('throw_bom', 1)	# 41-41	 **attackbox here**
    RefreshMultihit()
...
def Throw_bom_blink():
    ...
    sprite('null', 20)	# 1-20
    label(0)
    sprite('vr_ag311_00', 1)	# 21-21
    Unknown3001(63)
    sprite('vr_ag311_00', 1)	# 22-22
    Unknown3001(127)
    sprite('vr_ag311_00', 1)	# 23-23
    Unknown3001(191)
    sprite('vr_ag311_00', 1)	# 24-24
    Unknown3001(255)
    sprite('vr_ag311_00', 1)	# 25-25
    Unknown3001(191)
    sprite('vr_ag311_00', 1)	# 26-26
    Unknown3001(127)
    sprite('vr_ag311_00', 1)	# 27-27
    Unknown3001(63)
    sprite('vr_ag311_00', 1)	# 28-28
    Unknown3001(0)
    gotoLabel(0)
...
def dmy_r_action():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3032()
        Unknown3001(0)
    sprite('dmy_r_action', 4)	# 1-4	 **attackbox here**
    RefreshMultihit()
...
def DBarrierYugami():
    ...
    Unknown1056(200)
    Unknown1056(200)
    sprite('vr_ag_yugami_00', 20)	# 2-21
    Unknown1072(-15000)
    Unknown1059(150)
    Unknown1067(250)
...
def __5B_Matome():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4010(2)
        Unknown2055(200)
    sprite('dmy5AA_ExPoint', 2)	# 1-2
    GFX_0('5B_Shot', 4)
    Unknown23029(1, 2014, 0)
    SFX_3('ag002')
    sprite('dmy5AA_ExPoint', 2)	# 3-4
    GFX_0('5B_Shot', 5)
    Unknown23029(1, 2015, 0)
    SFX_3('ag002')
    sprite('dmy5AA_ExPoint', 2)	# 5-6
    GFX_0('5B_Shot', 6)
    Unknown23029(1, 2016, 0)
    SFX_3('ag002')
    sprite('dmy5AA_ExPoint', 2)	# 7-8
    GFX_0('5B_Shot', 7)
    Unknown23029(1, 2017, 0)
    SFX_3('ag002')
    sprite('dmy5AA_ExPoint', 2)	# 9-10
    GFX_0('5B_Shot', 8)
...
def __5B_Shot():
    ...
    sprite('dmy_machinegun', 60)	# 1-60	 **attackbox here**
    RefreshMultihit()
...
def __2B_Matome():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4010(2)
        Unknown2055(200)
    sprite('dmy2B_ExPoint', 2)	# 1-2
    GFX_0('2B_Shot', 3)
    Unknown23029(1, 2313, 0)
    SFX_3('ag002')
    sprite('dmy2B_ExPoint', 2)	# 3-4
    GFX_0('2B_Shot', 4)
    Unknown23029(1, 2314, 0)
    SFX_3('ag002')
    sprite('dmy2B_ExPoint', 2)	# 5-6
    GFX_0('2B_Shot', 5)
    Unknown23029(1, 2315, 0)
    SFX_3('ag002')
    sprite('dmy2B_ExPoint', 2)	# 7-8
    GFX_0('2B_Shot', 6)
    Unknown23029(1, 2316, 0)
    SFX_3('ag002')
    sprite('dmy2B_ExPoint', 2)	# 9-10
    GFX_0('2B_Shot', 7)
...
def Gatling_Matome():
    ...
    sprite('null', 2)	# 1-2
    label(0)
    sprite('dmyMachineGun_ExPoint', 2)	# 3-4
    GFX_0('Gatling_Shot', 0)
    if SLOT_2:
        Unknown23029(1, 4032, 0)
    SFX_3('ag002')
    sprite('dmyMachineGun_ExPoint', 2)	# 5-6
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 4032):
                Damage(180)
                AttackP2(70)
    sprite('dmy_machinegun00', 1)	# 1-1	 **attackbox here**
    RefreshMultihit()
    sprite('dmy_machinegun', 59)	# 2-60	 **attackbox here**
...
def Gatling_Matome_TAG():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown2055(200)
    label(0)
    sprite('dmyMachineGun_ExPoint', 2)	# 1-2
...
def AirBalkan_Matome():
    ...
    sprite('null', 2)	# 1-2
    label(0)
    sprite('dmyAirMachineGun_ExPoint', 2)	# 3-4
    GFX_0('agef_handgunflash_03A', 0)
    GFX_0('AirBalkan_Shot', 0)
    if SLOT_2:
        Unknown23029(1, 4072, 0)
    SFX_3('ag002')
    sprite('dmyAirMachineGun_ExPoint', 2)	# 5-6
    GFX_0('agef_handgunflash_03A', 0)
    GFX_0('AirBalkan_Shot', 0)
    Unknown36(1)
...
def AirBalkan_Shot():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 4072):
                Damage(250)
    sprite('dmy_machinegunex', 200)	# 1-200	 **attackbox here**
    RefreshMultihit()
...
def CanonShot_A():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown1028(-800)
        setGravity(2000)
    sprite('dmy_canon', 10)	# 1-10	 **attackbox here**
    sprite('dmy_canon', 2)	# 11-12	 **attackbox here**
    label(2)
    sprite('dmy_canon', 2)	# 13-14	 **attackbox here**
    loopRest()
    gotoLabel(2)
    label(3)
    sprite('dmy_canon00', 5)	# 15-19	 **attackbox here**
    RefreshMultihit()
    ...
    GFX_1('agef_bom_06', 0)
    Unknown3004(-50)
    sprite('dmy_canon00', 5)	# 20-24	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    sprite('dmy_canon00', 5)	# 25-29	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    sprite('dmy_canon00', 5)	# 30-34	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    DisableAttackRestOfMove()
    sprite('dmy_canon00', 5)	# 35-39	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    sprite('dmy_canon00', 5)	# 40-44	 **attackbox here**
    GFX_1('agef_bom_06', 0)
...
def AirCanonShot_A():
    ...
    def upon_IMMEDIATE():
        ...
        setGravity(700)
    sprite('dmy_canon', 10)	# 1-10	 **attackbox here**
    sprite('dmy_canon', 23)	# 11-33	 **attackbox here**
    sprite('dmy_canon', 2)	# 34-35	 **attackbox here**
    Unknown1028(0)
    label(2)
    sprite('dmy_canon', 2)	# 36-37	 **attackbox here**
    loopRest()
    gotoLabel(2)
    label(3)
    sprite('dmy_canon00', 5)	# 38-42	 **attackbox here**
    RefreshMultihit()
    callSubroutine('CanonShot_Atk2nd')
    SLOT_51 = 0
    Unknown2037(0)
    ...
    GFX_1('agef_bom_06', 0)
    Unknown3004(-50)
    sprite('dmy_canon00', 5)	# 43-47	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    sprite('dmy_canon00', 5)	# 48-52	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    sprite('dmy_canon00', 5)	# 53-57	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    sprite('dmy_canon00', 5)	# 58-62	 **attackbox here**
    GFX_1('agef_bom_06', 0)
    DisableAttackRestOfMove()
    sprite('dmy_canon00', 5)	# 63-67	 **attackbox here**
    GFX_1('agef_bom_06', 0)
...
def AtenaFlameEX():
    ...
    Unknown3004(17)
    Unknown1074(2000)
    sprite('null', 31)	# 21-51
    sprite('null', 10)	# 52-61
    Unknown3004(-26)
...
def Pandora_Matome():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown2055(300)
    label(0)
    sprite('dmyRapidMissile_ExPoint', 4)	# 1-4
    GFX_0('Pandora_Shot', 0)
    sprite('dmyRapidMissile_ExPoint', 4)	# 5-8
    GFX_0('Pandora_Shot', 1)
    sprite('dmyRapidMissile_ExPoint', 4)	# 9-12
    GFX_0('Pandora_Shot', 2)
    sprite('dmyRapidMissile_ExPoint', 4)	# 13-16
    GFX_0('Pandora_Shot', 3)
    sprite('dmyRapidMissile_ExPoint', 4)	# 17-20
    GFX_0('Pandora_Shot', 4)
    loopRest()
    gotoLabel(0)
    label(9)
    sprite('null', 300)	# 21-320
    Unknown4010(0)
...
def Pandora_Shot():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_46():
            Unknown13(25)
            SFX_3('bomb_m')
    sprite('dmy_missile', 19)	# 1-19	 **attackbox here**
    GFX_0('MissileBackfire', 0)
    physicsXImpulse(-20000)
    Unknown1028(700)
    SFX_3('ag005')
    sprite('dmy_missile', 21)	# 20-40	 **attackbox here**
    Unknown1028(1600)
    SLOT_13 = SLOT_41
    YAccel(1)
    sprite('dmy_missile', 10)	# 41-50	 **attackbox here**
    SFX_3('blaze_normal')
    label(0)
    sprite('dmy_missile', 30)	# 51-80	 **attackbox here**
    Unknown53(1)
    loopRest()
    gotoLabel(0)
...
def Spear_Reversal():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(2)
        Unknown3033()
    sprite('dmy_spear', 2)	# 1-2	 **attackbox here**
    GFX_0('throwEnagyD', 0)
    RefreshMultihit()
    physicsYImpulse(130000)
    ScreenShake(0, 8000)
    sprite('dmy_spear', 30)	# 3-32	 **attackbox here**
    GroundedHitstunAnimation(9)
    AirHitstunAnimation(9)
    AirUntechableTime(40)
    HitAirUnblockable(0)
...
def AddSpear():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown11058('0000000001000000000000000000000000000000')
        Unknown11084(1)
    sprite('dmy_spear', 60)	# 1-60	 **attackbox here**
    GFX_0('throwEnagyD', 0)
    RefreshMultihit()
    physicsYImpulse(130000)
    ScreenShake(0, 80000)
...
def Orion_Shot():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 6000):
                Unknown11069('')
    sprite('dmy_machinegunex', 4)	# 1-4	 **attackbox here**
    RefreshMultihit()
    sprite('dmy_machinegunex', 60)	# 5-64	 **attackbox here**
    Unknown11023(1)
...
def Ichigeki_Shot():
    ...
    label(0)
    sprite('null', 1)	# 1-1
    sprite('dmy_machinegunex', 32767)	# 2-32768	 **attackbox here**
    ...
    loopRest()
    label(1)
    sprite('dmy_canon', 10)	# 32769-32778	 **attackbox here**
    Unknown1110(120000, 0)
    Unknown9017(1)
    ...
    gotoLabel(1)
    label(2)
    sprite('dmy_canon', 10)	# 32779-32788	 **attackbox here**
    Unknown1110(120000, 0)
    AirPushbackX(20000)
    AirPushbackY(38000)
...
def BigYakkyo():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_LANDING():
            ...
            SFX_3('na006')
        Unknown4061(2)
    sprite('vr_trap_yakkyo2', 2)	# 1-2
    GFX_1('agef_yakkyoshock_smk', 0)
    physicsXImpulse(-25000)
    physicsYImpulse(30000)
    Unknown1074(-10000)
    setGravity(2000)
    sprite('vr_trap_yakkyo2', 2)	# 3-4
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 5-6
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 7-8
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 9-10
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 11-12
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 13-14
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 15-16
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 17-18
    GFX_1('agef_yakkyoshock_smk', 0)
    sprite('vr_trap_yakkyo2', 2)	# 19-20
    GFX_1('agef_yakkyoshock_smk', 0)
...
def IchigekiSpear():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 7024):
                sendToLabel(2)
    sprite('vr_at450_00', 1)	# 1-1	 **attackbox here**
    physicsXImpulse(70000)
    sprite('vr_at450_00', 32767)	# 2-32768	 **attackbox here**
    RefreshMultihit()
    label(0)
    sprite('vr_at450_00', 6)	# 32769-32774	 **attackbox here**
    sprite('vr_at450_00', 4)	# 32775-32778	 **attackbox here**
    Unknown36(22)
    physicsXImpulse(-70000)
    Unknown35()
    sprite('vr_at450_00', 10)	# 32779-32788	 **attackbox here**
    sprite('vr_at450_00', 6)	# 32789-32794	 **attackbox here**
    Unknown4004('534345465f46616465426c61636b3132496e000000000000000000000000000064000000')
    sprite('vr_at450_00', 4)	# 32795-32798	 **attackbox here**
    Unknown21015('41737472616c48656174000000000000000000000000000000000000000000005a1b000000000000')
    sprite('vr_at450_00', 1)	# 32799-32799	 **attackbox here**
    Unknown36(22)
    physicsXImpulse(0)
    physicsYImpulse(1)
    setGravity(0)
    ...
    physicsXImpulse(0)
    Unknown1007(200000)
    sprite('vr_at450_00', 19)	# 32800-32818	 **attackbox here**
    sprite('vr_at450_00', 300)	# 32819-33118	 **attackbox here**
    Unknown26('SCEF_FadeBlack12In')
    Unknown4004('534345465f46616465426c61636b31324f75740000000000000000000000000064000000')
    sprite('vr_at450_00', 4)	# 33119-33122	 **attackbox here**
    label(1)
    sprite('vr_at450_00', 4)	# 33123-33126	 **attackbox here**
    loopRest()
    gotoLabel(1)
    label(2)
    sprite('vr_at450_00', 4)	# 33127-33130	 **attackbox here**
    Unknown3001(0)
    loopRest()
    gotoLabel(2)
...
def IchigekiPicture():
    ...
    sprite('ichigeki0', 60)	# 6-65	 **attackbox here**
    Unknown1099(-1)
    physicsXImpulse(-350)
    physicsYImpulse(-500)
    sprite('keep', 5)	# 66-70
...
def Ichigeki_LastShot():
    ...
    sprite('dmy_ichigekitama', 10)	# 1-10	 **attackbox here**
    physicsXImpulse(3000)
    sprite('dmy_ichigekitama', 5)	# 11-15	 **attackbox here**
    ScreenShake(3000, 3000)
    Unknown3004(51)
    Unknown21015('4963686967656b6943616d657261000000000000000000000000000000000000651b000000000000')
    sprite('dmy_ichigekitama', 4)	# 16-19	 **attackbox here**
    ScreenShake(3000, 3000)
    RefreshMultihit()
    physicsXImpulse(80000)
    SFX_3('ag010')
    sprite('dmy_ichigekitama', 12)	# 20-31	 **attackbox here**
    RefreshMultihit()
    sprite('dmy_ichigekitama', 20)	# 32-51	 **attackbox here**
    RefreshMultihit()
    physicsXImpulse(0)
    sprite('dmy_ichigekitama', 20)	# 52-71	 **attackbox here**
    SFX_3('ag010')
    sprite('dmy_ichigekitama', 12)	# 72-83	 **attackbox here**
    Unknown4004('534345465f46616465426c61636b3132496e000000000000000000000000000064000000')
    sprite('dmy_ichigekitama', 60)	# 84-143	 **attackbox here**
    physicsXImpulse(80000)
    Unknown1007(500000)
    ...
    SFX_3('ag010')
    label(0)
    sprite('dmy_ichigekitama', 4)	# 144-147	 **attackbox here**
    RefreshMultihit()
    loopRest()
    gotoLabel(0)
    label(1)
    sprite('dmy_ichigekitama', 3)	# 148-150	 **attackbox here**
    SFX_3('damage_magic_mh')
    sprite('dmy_ichigekitama', 3)	# 151-153	 **attackbox here**
    SFX_3('damage_magic_mh')
    sprite('dmy_ichigekitama', 3)	# 154-156	 **attackbox here**
    SFX_3('damage_magic_mh')
    sprite('dmy_ichigekitama', 11)	# 157-167	 **attackbox here**
    sprite('dmy_ichigekitama', 20)	# 168-187	 **attackbox here**
    Unknown3004(-26)
...
def Ichigekiwhite():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3032()
        Unknown3001(0)
    sprite('vr_ag450_white', 30)	# 1-30
    Unknown3004(30)
    sprite('vr_ag450_white', 100)	# 31-130
    Unknown3004(-26)
    sprite('vr_ag450_white', 10)	# 131-140
...
def IchigekiCamera():
    ...
    Unknown1086(3)
    label(3)
    sprite('keep', 19)	# 65565-65583
    Unknown1086(4)
    physicsXImpulse(80000)
    sprite('null', 32767)	# 65584-98350
    physicsXImpulse(0)
    label(4)
    sprite('null', 32767)	# 98351-131117
    Unknown1086(22)
    physicsXImpulse(0)
    Unknown1007(200000)
    label(5)
    sprite('keep', 32767)	# 131118-163884
    physicsXImpulse(0)
    physicsYImpulse(0)
    Unknown20009(1000)
    Unknown1086(3)
...
def agef_entry1():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3032()
        Unknown3001(250)
    sprite('vr_agef600_15', 5)	# 1-5
    Unknown3004(-13)
    sprite('vr_agef600_16', 5)	# 6-10
    sprite('vr_agef600_17', 5)	# 11-15
    sprite('vr_agef600_18', 5)	# 16-20
...
def agef_entry2_pod():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown23069(1)
        sendToLabelUpon(32, 0)
    sprite('vr_agef601_pod00', 32767)	# 1-32767
    label(0)
    sprite('vr_agef601_pod02', 3)	# 32768-32770
    sprite('vr_agef601_pod04', 3)	# 32771-32773
    sprite('vr_agef601_pod06', 3)	# 32774-32776
    sprite('vr_agef601_pod08', 3)	# 32777-32779
    sprite('vr_agef601_pod10', 3)	# 32780-32782
    sprite('vr_agef601_pod12', 3)	# 32783-32785
    sprite('vr_agef601_pod14', 3)	# 32786-32788
    sprite('vr_agef601_pod15', 3)	# 32789-32791
...
def agef_entry2_pod2():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown23069(1)
        sendToLabelUpon(32, 0)
    sprite('vr_agef601_pod01', 32767)	# 1-32767
    label(0)
    sprite('vr_agef601_pod03', 3)	# 32768-32770
    sprite('vr_agef601_pod05', 3)	# 32771-32773
    sprite('vr_agef601_pod07', 3)	# 32774-32776
    sprite('vr_agef601_pod09', 3)	# 32777-32779
    sprite('vr_agef601_pod11', 3)	# 32780-32782
    sprite('vr_agef601_pod13', 3)	# 32783-32785
...
def agef_entry2_hole():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown13044(1)
        sendToLabelUpon(32, 0)
    sprite('vr_agef601_hole00', 32767)	# 1-32767
    label(0)
    sprite('vr_agef601_hole01', 6)	# 32768-32773
    SFX_3('ag003')
    sprite('vr_agef601_hole02', 6)	# 32774-32779
    sprite('vr_agef601_hole03', 30)	# 32780-32809
    sprite('vr_agef601_hole02', 6)	# 32810-32815
    SFX_3('ag003')
    sprite('vr_agef601_hole01', 6)	# 32816-32821
    sprite('vr_agef601_hole00', 10)	# 32822-32831
    sprite('vr_agef601_hole00', 32767)	# 32832-65598
    Unknown3004(-8)
...
def agef_entry2_seat():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown23069(1)
        sendToLabelUpon(32, 0)
    sprite('vr_agef601_seat', 32767)	# 1-32767
    label(0)
    sprite('vr_agef601_seat00', 3)	# 32768-32770
    sprite('vr_agef601_seat01', 3)	# 32771-32773
    sprite('vr_agef601_seat02', 3)	# 32774-32776
...
def agef_entry2_ring():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown23069(1)
        sendToLabelUpon(32, 0)
    sprite('vr_agef601_ring00', 32767)	# 1-32767
    label(0)
    sprite('vr_agef601_ring00', 1)	# 32768-32768
    sprite('vr_agef601_ring01', 4)	# 32769-32772
    sprite('vr_agef601_ring02', 4)	# 32773-32776
    sprite('vr_agef601_ring03', 4)	# 32777-32780
    sprite('vr_agef601_ring04', 4)	# 32781-32784
    sprite('vr_agef601_ring05', 4)	# 32785-32788
    sprite('vr_agef601_ring06', 4)	# 32789-32792
...
def PersonaWin2():
    ...
    def upon_IMMEDIATE():
        ...
        callSubroutine('PAG_CheckWarp')
    sprite('at611_00', 20)	# 1-20
    sprite('at611_01', 2)	# 21-22
    GFX_0('Win2', 100)
    sprite('at611_02', 2)	# 23-24
    sprite('at611_03', 2)	# 25-26
    SFX_3('slash_pole_fast')
    sprite('at611_04', 3)	# 27-29
    sprite('at611_05', 3)	# 30-32
    sprite('at611_06', 6)	# 33-38
    sprite('at611_07', 6)	# 39-44
    label(3)
    sprite('at611_08', 4)	# 45-48
    sprite('at611_09', 4)	# 49-52
    sprite('at611_10', 4)	# 53-56
    gotoLabel(3)
...
def Win2():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3032()
        Unknown4061(1)
    sprite('vr_at611_00', 2)	# 1-2
    sprite('vr_at611_01', 2)	# 3-4
    sprite('vr_at611_02', 4)	# 5-8
