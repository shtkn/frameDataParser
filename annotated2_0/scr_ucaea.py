...
def DoubleShotCharge():
    ...
    def upon_IMMEDIATE():
        ...
        teleportRelativeX(300000)
    sprite('null', 1)	# 1-1
    sprite('Action_154_00', 2)	# 2-3
    SFX_3('SE_BloodSplashB')
    sprite('Action_154_01', 2)	# 4-5
    sprite('Action_154_02', 2)	# 6-7	 **attackbox here**
    sprite('Action_154_03', 8)	# 8-15
    sprite('Action_154_04', 3)	# 16-18	 **attackbox here**
    Unknown23015(11)
    sprite('Action_154_05', 3)	# 19-21	 **attackbox here**
    sprite('Action_154_06', 3)	# 22-24	 **attackbox here**
...
def BloodAtk_DS():
    ...
    def upon_IMMEDIATE():
        ...
        teleportRelativeY(0)
        Unknown23023()
    sprite('Action_154_07', 1)	# 1-1	 **attackbox here**
    Unknown23145('DoubleShotCharge')
    if SLOT_ReturnVal:
        _gotolabel(0)
    sprite('Action_154_07', 21)	# 2-22	 **attackbox here**
    label(0)
    sprite('Action_154_08', 3)	# 23-25	 **attackbox here**
    sprite('Action_154_09', 3)	# 26-28	 **attackbox here**
    sprite('Action_154_10', 3)	# 29-31	 **attackbox here**
    sprite('Action_154_11', 3)	# 32-34	 **attackbox here**
    sprite('Action_154_12', 3)	# 35-37	 **attackbox here**
    sprite('Action_154_13', 3)	# 38-40	 **attackbox here**
    sprite('Action_154_16', 3)	# 41-43	 **attackbox here**
    sprite('Action_154_17', 5)	# 44-48	 **attackbox here**
    sprite('Action_154_18', 4)	# 49-52	 **attackbox here**
    sprite('Action_154_19', 2)	# 53-54	 **attackbox here**
    sprite('Action_154_20', 2)	# 55-56	 **attackbox here**
    Unknown23015(0)
    sprite('Action_154_21', 2)	# 57-58
    sprite('Action_154_22', 18)	# 59-76	 **attackbox here**
    RefreshMultihit()
    SFX_3('SE_BloodSplashB')
    sprite('Action_154_23', 10)	# 77-86
    sprite('Action_154_24', 3)	# 87-89
    sprite('Action_154_25', 3)	# 90-92
    sprite('Action_154_26', 3)	# 93-95
    sprite('Action_154_27', 1)	# 96-96
