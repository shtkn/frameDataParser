...
def MatchInit():
    ...
    Unknown7010(112, 'ahe159_0')
    Unknown7010(113, 'ahe159_1')
...
def CmnActAirOverDriveEnd():
    ...
    sprite('ahe020_05', 3)	# 7-9
    sprite('ahe020_06', 3)	# 10-12
    label(0)
    sprite('ahe020_07', 4)	# 13-16
    sprite('ahe020_08', 4)	# 17-20
    loopRest()
    gotoLabel(0)
...
def CmnActChangePartnerIn():
    ...
    sprite('ahe276_03', 2)	# 631-632
    Unknown1086(22)
    teleportRelativeX(-150000)
    teleportRelativeY(1500000)
    physicsYImpulse(-300000)
    sprite('ahe276_04', 32767)	# 633-33399	 **attackbox here**
    label(1)
    sprite('keep', 3)	# 33400-33402
    sprite('ahe406_05', 3)	# 33403-33405
    Unknown1084(1)
    Unknown8000(100, 1, 1)
    sprite('ahe406_06', 5)	# 33406-33410	 **attackbox here**
    sprite('ahe406_07', 5)	# 33411-33415
    sprite('ahe010_02', 3)	# 33416-33418
    sprite('ahe010_01', 3)	# 33419-33421
    sprite('ahe010_00', 3)	# 33422-33424
...
def CmnActAComboFinalBlow():
    ...
    Unknown1019(4)
    label(0)
    sprite('ahe276_04', 3)	# 32-34	 **attackbox here**
    gotoLabel(0)
    label(1)
    sprite('ahe276_04ex', 1)	# 35-35	 **attackbox here**
    Unknown1019(10)
    sprite('ahe406_05', 5)	# 36-40
    if SLOT_3:
        enterState('CmnActAComboFinalBlowFinish')
    Unknown8000(100, 1, 1)
    sprite('ahe406_06', 6)	# 41-46	 **attackbox here**
    Unknown23022(0)
    sprite('ahe406_07', 6)	# 47-52
    sprite('ahe010_02', 4)	# 53-56
    Unknown1084(1)
    sprite('ahe010_01', 4)	# 57-60
    sprite('ahe010_00', 4)	# 61-64
...
def CmnActAComboFinalBlowFinish():
    ...
    def upon_IMMEDIATE():
        AttackDefaults_StandingSpecial()
        Unknown2004(1, 0)
    sprite('ahe406_05', 3)	# 1-3
    sprite('ahe406_06', 2)	# 4-5	 **attackbox here**
    StartMultihit()
    sprite('ahe406_07', 2)	# 6-7
    sprite('ahe010_02', 2)	# 8-9
    Unknown1084(1)
    sprite('ahe010_01', 3)	# 10-12
    sprite('ahe010_00', 3)	# 13-15
    sprite('ahe400_00', 3)	# 16-18
    sprite('ahe400_01', 3)	# 19-21
    sprite('ahe400_02', 3)	# 22-24
    setInvincible(1)
    sprite('ahe400_03', 3)	# 25-27
    sprite('ahe400_04', 3)	# 28-30
    physicsXImpulse(15000)
    Unknown8009(0)
    SFX_3('ahese_03')
    Unknown2015(175)
    Unknown7009(2)
    sprite('ahe400_04', 2)	# 31-32
    Unknown1019(150)
    Unknown8006(100, 1, 0)
    sprite('ahe400_05', 2)	# 33-34
    Unknown1019(200)
    sprite('ahe400_06', 2)	# 35-36	 **attackbox here**
    RefreshMultihit()
    GFX_0('ahe400_attack_eff', 100)
    Unknown38(8, 1)
    GFX_0('ahe401_dust_eff', 100)
    Unknown8006(100, 1, 0)
    sprite('ahe200_06', 5)	# 37-41	 **attackbox here**
    Unknown23029(8, 5031, 0)
    StartMultihit()
    sprite('ahe600_00', 5)	# 42-46
    Unknown8006(100, 1, 0)
    Unknown1019(50)
    sprite('ahe600_01', 5)	# 47-51
    sprite('ahe600_00', 5)	# 52-56
    Unknown1019(50)
    sprite('ahe600_01', 5)	# 57-61
    sprite('ahe600_00', 5)	# 62-66
    Unknown1019(50)
    sprite('ahe032_06', 3)	# 67-69
    teleportRelativeX(20000)
    Unknown1084(1)
    Unknown1047(3000)
    sprite('ahe032_07', 3)	# 70-72
    sprite('ahe032_08', 3)	# 73-75
        ...
        def upon_CLEAR_OR_EXIT():
            if SLOT_51:
                if SLOT_2:
                    ...
                    clearUponHandler(17)
                    sendToLabel(1)
            elif (not SLOT_IsUnlimitedCharacter):
...
def CmnActCrushAttackExFinish():
    ...
    gotoLabel(0)
    label(1)
    sprite('ahe000_00', 5)	# 81-85	 **attackbox here**
    sprite('ahe271_05', 5)	# 86-90
    sprite('ahe274_01', 6)	# 91-96
    sprite('ahe274_02', 3)	# 97-99
    physicsXImpulse(15000)
    sprite('ahe274_03', 3)	# 100-102	 **attackbox here**
    RefreshMultihit()
    Unknown1019(0)
    tag_voice(0, 'ahe158_0', 'ahe158_1', '', '')
    sprite('ahe274_03', 2)	# 103-104	 **attackbox here**
    StartMultihit()
    sprite('ahe274_04', 5)	# 105-109
    sprite('ahe274_05', 3)	# 110-112
    sprite('ahe274_06', 3)	# 113-115
    sprite('ahe274_07', 3)	# 116-118
    sprite('ahe274_08', 3)	# 119-121
    sprite('ahe271_06', 5)	# 122-126
    sprite('ahe271_07', 5)	# 127-131
    sprite('ahe271_08', 5)	# 132-136
    sprite('ahe271_09', 4)	# 137-140
...
def HomingAction3():
    ...
    def upon_IMMEDIATE():
        ...
        if Unknown23145('NHomingDash'):
            ...
            SLOT_65 = 1
    sprite('keep', 1)	# 1-1
    sprite('ahe020_04', 2)	# 2-3
    Unknown23183('6168653033325f30326578303100000000000000000000000000000000000000020000000200000033000000')
    sprite('ahe035_00', 3)	# 4-6
