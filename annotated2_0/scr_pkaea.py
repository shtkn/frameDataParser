...
def PKA_PersonaTsukameB():
    ...
    Unknown2006()
    sprite('ta405_00', 20)	# 6-25
    if (not SLOT_52):
        sendToLabel(100)
    sprite('ta405_00', 100)	# 26-125
    AirPushbackX(0)
    AirPushbackY(3000)
    ...
    def upon_CLEAR_OR_EXIT():
        if (SLOT_41 > 100000):
            sendToLabel(100)
    label(100)
    sprite('ta405_01', 2)	# 126-127	 **attackbox here**
    clearUponHandler(3)
    Unknown3029(1)
    Unknown4007(0)
    Unknown2053(1)
    ...
    sprite('ta405_01', 1)	# 128-128	 **attackbox here**
    RefreshMultihit()
    sprite('ta405_01', 1)	# 129-129	 **attackbox here**
    sprite('ta405_01', 1)	# 130-130	 **attackbox here**
    sprite('ta405_01', 1)	# 131-131	 **attackbox here**
    sprite('ta405_01', 1)	# 132-132	 **attackbox here**
    sprite('ta405_01', 1)	# 133-133	 **attackbox here**
    sprite('ta405_01', 1)	# 134-134	 **attackbox here**
    sprite('ta405_01', 1)	# 135-135	 **attackbox here**
    sprite('ta405_01', 1)	# 136-136	 **attackbox here**
    Unknown1019(45)
    YAccel(45)
    sprite('ta405_01', 1)	# 137-137	 **attackbox here**
    sprite('ta405_01', 1)	# 138-138	 **attackbox here**
    sprite('ta405_02', 2)	# 139-140	 **attackbox here**
    Unknown3029(0)
    DisableAttackRestOfMove()
    setInvincible(0)
    SLOT_10 = 0
    sprite('ta405_03', 2)	# 141-142
    sprite('ta405_04', 2)	# 143-144	 **attackbox here**
    Unknown1019(80)
    YAccel(80)
    sprite('ta405_04', 4)	# 145-148	 **attackbox here**
    Unknown1019(80)
    YAccel(80)
    sprite('ta405_04', 4)	# 149-152	 **attackbox here**
    Unknown1019(80)
    YAccel(80)
    sprite('ta405_04', 4)	# 153-156	 **attackbox here**
    Unknown1019(80)
    YAccel(80)
    sprite('ta405_04', 4)	# 157-160	 **attackbox here**
    Unknown1019(80)
    YAccel(80)
    sprite('ta405_04', 5)	# 161-165	 **attackbox here**
    Unknown1019(50)
    YAccel(50)
    sprite('ta405_04', 15)	# 166-180	 **attackbox here**
    Unknown1019(50)
    YAccel(50)
...
def PKA_PersonaTsukameTame_Exe():
    ...
    YAccel(0)
    clearUponHandler(3)
    sprite('ta405_04', 1)	# 26-26	 **attackbox here**
    RefreshMultihit()
    SFX_3('electric_l')
    ScreenShake(24000, 0)
    GFX_0('ta_AntiAir', 100)
    GFX_1('taef_antiair', 1)
    sprite('ta405_04', 2)	# 27-28	 **attackbox here**
    Unknown36(22)
    Unknown23178(16)
    Unknown35()
    sprite('ta405_04', 1)	# 29-29	 **attackbox here**
    RefreshMultihit()
    sprite('ta405_04', 2)	# 30-31	 **attackbox here**
    Unknown36(22)
    Unknown23178(17)
    Unknown35()
    sprite('ta405_04', 2)	# 32-33	 **attackbox here**
    RefreshMultihit()
    GFX_0('ta_AntiAir', 100)
    GFX_1('taef_antiair', 1)
    sprite('ta405_04', 1)	# 34-34	 **attackbox here**
    Unknown36(22)
    Unknown23178(16)
    Unknown35()
    sprite('ta405_04', 2)	# 35-36	 **attackbox here**
    RefreshMultihit()
    sprite('ta405_04', 1)	# 37-37	 **attackbox here**
    Unknown36(22)
    Unknown23178(17)
    Unknown35()
    sprite('ta405_04', 2)	# 38-39	 **attackbox here**
    RefreshMultihit()
    ScreenShake(24000, 0)
    GFX_0('ta_AntiAir', 100)
    GFX_1('taef_antiair', 1)
    sprite('ta405_04', 1)	# 40-40	 **attackbox here**
    Unknown36(22)
    Unknown23178(16)
    Unknown35()
    sprite('ta405_04', 2)	# 41-42	 **attackbox here**
    RefreshMultihit()
    sprite('ta405_04', 1)	# 43-43	 **attackbox here**
    Unknown36(22)
    Unknown23178(17)
    Unknown35()
    sprite('ta405_04', 2)	# 44-45	 **attackbox here**
    RefreshMultihit()
    GFX_0('ta_AntiAir', 100)
    GFX_1('taef_antiair', 1)
    sprite('ta405_04', 1)	# 46-46	 **attackbox here**
    Unknown36(22)
    Unknown23178(16)
    Unknown35()
    sprite('ta405_04', 20)	# 47-66	 **attackbox here**
...
def ka_isuokiseme():
    ...
    ExitState()
    label(99)
    sprite('vr_ka430_01', 220)	# 98899-99118	 **attackbox here**
    sprite('vr_ka430_01', 1)	# 99119-99119	 **attackbox here**
    Unknown1086(22)
    Unknown1084(1)
    teleportRelativeY(2000000)
    teleportRelativeX(0)
    sprite('vr_ka430_01', 32767)	# 99120-131886	 **attackbox here**
    RefreshMultihit()
    physicsYImpulse(-60000)
    setGravity(0)
    Unknown1074(15000)
