        ...
        def upon_CLEAR_OR_EXIT():
            ...
            if SLOT_IsUnlimitedCharacter:
                if (not (SLOT_51 == 6)):
                    ...
                    sendToLabel(1)
    label(0)
    sprite('ubl030_00ex', 32767)
    label(1)
    sprite('ubl030_00ex', 1)
    GFX_0('ubl_forward_Eff', 100)
    sprite('ubl030_01ex', 1)
    sprite('ubl030_02ex', 1)
    GFX_0('ubl_forward_Eff', 100)
    sprite('ubl030_03ex', 1)
    sprite('ubl030_04ex', 1)
    GFX_0('ubl_forward_Eff', 100)
    sprite('ubl030_05ex', 1)
    sprite('ubl030_06ex', 1)
    GFX_0('ubl_forward_Eff', 100)
    sprite('ubl030_07ex', 1)
    loopRest()
    gotoLabel(1)
    label(2)
    sprite('ubl030_07ex', 1)
...
def ShotBeam_Low():
    ...
    sprite('vr_ubl_NormalShotAtkCol00', 3)
    RefreshMultihit()
    sprite('vr_ubl_NormalShotAtkCol00', 10)
    DisableAttackRestOfMove()
    label(9)
    sprite('null', 1)
...
def GrenadeA_Shot():
    ...
    gotoLabel(0)
    label(1)
    sprite('vr_ubl_GranadeAtkCol00', 3)
    RefreshMultihit()
    ...
    def upon_IMMEDIATE():
        ...
        def upon_CLEAR_OR_EXIT():
            ...
            if (SLOT_2 > SLOT_51):
                ...
                Unknown23022(1)
    label(0)
    sprite('vr_ubl_UltimateBeamAtkCol00', 2)
    RefreshMultihit()
    Unknown2038(1)
    if (not (SLOT_2 > 26)):
        pass
