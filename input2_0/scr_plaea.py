...
def laef600_axe():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(0)
        Unknown3032()
    sprite('vr_la600_w10', 32)
    Unknown1007(512000)
    physicsYImpulse(-16000)
    sprite('vr_la600_w11', 4)
    physicsYImpulse(0)
    sprite('vr_la600_w12', 4)
    sprite('vr_la600_w13', 4)
...
def vr_lp406_1statk():
    ...
    sprite('lp406_atk00', 1)
    Unknown1064(1000)
    RefreshMultihit()
    sprite('lp406_atk00ex', 13)
    sprite('lp406_atk00', 2)
    DisableAttackRestOfMove()
    loopRest()
    ExitState()
    label(10)
...
def __407Shot_atk_SB():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_82():
            ...
            sendToLabel(100)
        Unknown11063(1)
    sprite('vr_la407_atkcol', 30)
    StartMultihit()
    Unknown1099(-3)
    sprite('vr_la407_atkcol', 1)
    RefreshMultihit()
    Unknown11063(0)
    sprite('vr_la407_atkcol', 100)
    ExitState()
    label(100)
    sprite('null', 1)
    sprite('null', 1)
...
def vr_lp232atk():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4010(3)
        teleportRelativeX(-50000)
    sprite('vr_lp232atkcol04', 3)
    RefreshMultihit()
    sprite('vr_lp232atkcol00', 3)
    RefreshMultihit()
    SFX_3('slash_pole_slow')
    sprite('vr_lp232atkcol01', 3)
    RefreshMultihit()
    sprite('vr_lp232atkcol02', 7)
...
def vr_lp204atk():
    ...
    sprite('vr_lp204atkcol_00ex01', 4)
    RefreshMultihit()
    AirPushbackX(16000)
    sprite('vr_lp204atkcol_01ex01', 4)
    RefreshMultihit()
    PushbackX(0)
    AirPushbackX(1500)
    sprite('vr_lp204atkcol_02ex01', 3)
    RefreshMultihit()
    PushbackX(-19800)
    AirPushbackX(-9800)
    ...
    sprite('vr_lp204atkcol_02ex01', 3)
    sprite('vr_lp204atkcol_03ex01', 6)
    RefreshMultihit()
    PushbackX(-29700)
    AirPushbackX(-15000)
    sprite('null', 3)
...
def vr_lp205atk():
    ...
    sprite('null', 5)
    sprite('vr_lp205atkcol', 7)
    RefreshMultihit()
    sprite('vr_lp205atkcol', 7)
    RefreshMultihit()
    sprite('vr_lp205atkcol', 5)
    RefreshMultihit()
    sprite('vr_lp205atkcol', 2)
    Unknown1084(1)
...
def vr_lp205atkUP():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_ON_HIT_OR_BLOCK():
            Unknown23029(3, 204, 0)
    sprite('vr_lp205atkcol_00', 4)
    RefreshMultihit()
    SFX_3('slash_rapier_fast')
    sprite('vr_lp205atkcol_01', 4)
    sprite('vr_lp205atkcol_02', 4)
    sprite('vr_lp205atkcol_03', 4)
    loopRest()
...
def vr_lp205atkDOWN():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_ON_HIT_OR_BLOCK():
            Unknown23029(3, 204, 0)
    sprite('vr_lp205atkcol_10', 4)
    RefreshMultihit()
    SFX_3('slash_rapier_fast')
    sprite('vr_lp205atkcol_11', 4)
    sprite('vr_lp205atkcol_12', 4)
    sprite('vr_lp205atkcol_13', 4)
    loopRest()
...
def vr_lp255atk_0():
    ...
    sprite('null', 10)
    sprite('vr_lp255atkcol_0ex01', 40)
    RefreshMultihit()
    loopRest()
...
def vr_lp255atk_2():
    ...
    def upon_IMMEDIATE():
        ...
        callSubroutine('vr_lp255atk_param')
    sprite('null', 10)
    sprite('vr_lp255atkcol_2ex01', 40)
    RefreshMultihit()
    loopRest()
...
def Ichigeki_atk():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_78():
            ...
            Unknown35()
        GFX_0('450line', 100)
    sprite('vr_lp450atkcol', 10)
    DisableAttackRestOfMove()
    sprite('vr_lp450atkcol', 15)
    RefreshMultihit()
    Unknown1059(120)
    sprite('vr_lp450atkcol', 30)
    DisableAttackRestOfMove()
    loopRest()
...
def __450eyelight():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 5003):
                sendToLabel(0)
    sprite('vr_la450_eye00', 15)
    sprite('vr_la450_eye00', 140)
    Unknown3004(20)
    label(0)
    sprite('vr_la450_eye00', 15)
    clearUponHandler(43)
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 5006):
                sendToLabel(0)
        Unknown3004(20)
    sprite('vr_la450_black', 32767)
    label(0)
    sprite('vr_la450_black', 10)
    Unknown3004(-26)
