...
def CmnActAirOverDriveEnd():
    sprite('ha333_09', 4)	# 1-4
    sprite('ha333_10', 4)	# 5-8
    sprite('ha333_11', 4)	# 9-12
    label(0)
    sprite('ha020_06', 4)	# 13-16
    sprite('ha020_07', 4)	# 17-20
    loopRest()
...
def CmnActChangePartnerIn():
    ...
    sprite('ha404_04', 2)	# 26-27
    sprite('ha404_05', 2)	# 28-29
    sprite('ha404_06', 2)	# 30-31
    sprite('ha404_07', 2)	# 32-33
    sprite('ha404_08', 2)	# 34-35
    ...
    Unknown2017(1)
    sendToLabelUpon(2, 9)
    sprite('ha404_09', 3)	# 36-38	 **attackbox here**
    GFX_0('ha_404', -1)
    sprite('ha404_10', 2)	# 39-40
    sprite('ha404_11', 2)	# 41-42
    sprite('ha404_12', 2)	# 43-44
    sprite('ha404_13', 3)	# 45-47
    Unknown1043()
    sprite('ha404_14', 3)	# 48-50
    sprite('ha404_15', 3)	# 51-53
    sprite('ha404_16', 3)	# 54-56
    sprite('ha020_03', 3)	# 57-59
    sprite('ha020_04', 3)	# 60-62
    sprite('ha020_05', 3)	# 63-65
    label(1)
    sprite('ha020_06', 3)	# 66-68
    sprite('ha020_07', 3)	# 69-71
    loopRest()
    gotoLabel(1)
    label(9)
    sprite('ha024_00', 2)	# 72-73
    Unknown8000(100, 1, 1)
    Unknown1084(1)
    sprite('ha024_01', 2)	# 74-75
    sprite('ha024_02', 2)	# 76-77
    sprite('ha024_03', 2)	# 78-79
    sprite('ha024_04', 1)	# 80-80
...
def NmlAtkAIR5C():
    ...
    SFX_0('004_swing_grap_1_2')
    SFX_0('004_swing_grap_1_2')
    sprite('ha405_05', 3)	# 11-13	 **attackbox here**
    GFX_0('ha_air_kick', -1)
...
def CmnActInvincibleAttack():
    ...
    sprite('ha203_17', 5)	# 11-15
    sprite('ha203_18', 5)	# 16-20
    Unknown21012('68615f354400000000000000000000000000000000000000000000000000000020000000')
    setInvincible(0)
    sprite('ha203_19', 10)	# 21-30
    sprite('ha203_20', 5)	# 31-35
    sprite('ha203_21', 5)	# 36-40
    sprite('ha203_22', 4)	# 41-44
    sprite('ha203_22', 1)	# 45-45
    SFX_3('hase_22')
...
def CmnActEntry():
    ...
    ExitState()
    label(991)
    sprite('ha000_00', 1)	# 36830-36830
    Unknown2019(1000)
    Unknown21011(120)
    label(992)
    sprite('ha000_00', 7)	# 36831-36837
    sprite('ha000_01', 7)	# 36838-36844
    sprite('ha000_02', 7)	# 36845-36851
    sprite('ha000_03', 7)	# 36852-36858
    sprite('ha000_04', 7)	# 36859-36865
    sprite('ha000_05', 7)	# 36866-36872
    sprite('ha000_06', 7)	# 36873-36879
    sprite('ha000_07', 7)	# 36880-36886
    sprite('ha000_08', 7)	# 36887-36893
    sprite('ha000_09', 7)	# 36894-36900
    sprite('ha000_10', 7)	# 36901-36907
    sprite('ha000_11', 7)	# 36908-36914
    gotoLabel(992)
    label(993)
    sprite('ha033_00', 2)	# 36915-36916
    ...
    setGravity(1500)
    Unknown8002()
    sprite('ha033_01', 3)	# 36917-36919
    label(994)
    sprite('ha033_02', 3)	# 36920-36922
    sprite('ha033_01', 3)	# 36923-36925
    loopRest()
    gotoLabel(994)
    label(995)
    sprite('null', 3)	# 36926-36928
    ExitState()
    label(1000)
    sprite('ha000_00', 7)	# 36929-36935
    Unknown1000(-200000)
    if (not SLOT_158):
        Unknown1000(-350000)
    ...
    def upon_43():
        if (SLOT_48 == 10003):
            clearUponHandler(43)
            sendToLabel(1001)
    sprite('ha000_01', 7)	# 36936-36942
    sprite('ha000_02', 7)	# 36943-36949
    sprite('ha000_03', 7)	# 36950-36956
    sprite('ha000_04', 7)	# 36957-36963
    sprite('ha000_05', 7)	# 36964-36970
    sprite('ha000_06', 7)	# 36971-36977
    sprite('ha000_07', 7)	# 36978-36984
    sprite('ha000_08', 7)	# 36985-36991
    sprite('ha000_09', 7)	# 36992-36998
    sprite('ha000_10', 7)	# 36999-37005
    sprite('ha000_11', 7)	# 37006-37012
    gotoLabel(1000)
    label(1001)
    sprite('ha300_00', 6)	# 37013-37018
    SFX_1('bha603')
    sprite('ha300_01', 6)	# 37019-37024
    sprite('ha300_02', 6)	# 37025-37030
    sprite('ha300_03', 6)	# 37031-37036
    sprite('ha300_04', 6)	# 37037-37042
    sprite('ha300_05', 6)	# 37043-37048
    sprite('ha300_06', 6)	# 37049-37054
    sprite('ha300_07', 6)	# 37055-37060
    sprite('ha300_08', 6)	# 37061-37066
    sprite('ha300_09', 200)	# 37067-37266
    sprite('ha300_10', 8)	# 37267-37274
    sprite('ha300_11', 8)	# 37275-37282
    sprite('ha300_12', 8)	# 37283-37290
    sprite('ha000_00', 7)	# 37291-37297
    sprite('ha000_01', 7)	# 37298-37304
    sprite('ha000_02', 7)	# 37305-37311
    sprite('ha000_03', 7)	# 37312-37318
    sprite('ha000_04', 7)	# 37319-37325
    sprite('ha000_05', 7)	# 37326-37332
    sprite('ha000_06', 7)	# 37333-37339
    sprite('ha000_07', 7)	# 37340-37346
    sprite('ha000_08', 7)	# 37347-37353
    sprite('ha000_09', 7)	# 37354-37360
    sprite('ha000_10', 7)	# 37361-37367
    sprite('ha000_11', 7)	# 37368-37374
    sprite('ha601_22', 7)	# 37375-37381
    Unknown23029(24, 10004, 0)
    Unknown23029(22, 10004, 0)
    Unknown23029(23, 10004, 0)
    sprite('ha601_21', 7)	# 37382-37388
    sprite('ha601_20', 7)	# 37389-37395
    sprite('ha601_19', 7)	# 37396-37402
    sprite('ha601_18', 7)	# 37403-37409
    sprite('ha601_17', 7)	# 37410-37416
    sprite('ha601_16', 7)	# 37417-37423
    sprite('ha601_15', 7)	# 37424-37430
    sprite('ha601_14', 7)	# 37431-37437
    sprite('ha601_15', 7)	# 37438-37444
    sprite('ha601_16', 7)	# 37445-37451
    sprite('ha601_17', 7)	# 37452-37458
    sprite('ha601_18', 7)	# 37459-37465
    sprite('ha601_19', 7)	# 37466-37472
    sprite('ha601_20', 7)	# 37473-37479
    sprite('ha601_21', 7)	# 37480-37486
    sprite('ha601_22', 7)	# 37487-37493
    Unknown23018(1)
    label(1002)
    sprite('ha000_00', 7)	# 37494-37500
    sprite('ha000_01', 7)	# 37501-37507
    sprite('ha000_02', 7)	# 37508-37514
    sprite('ha000_03', 7)	# 37515-37521
    sprite('ha000_04', 7)	# 37522-37528
    sprite('ha000_05', 7)	# 37529-37535
    sprite('ha000_06', 7)	# 37536-37542
    sprite('ha000_07', 7)	# 37543-37549
    sprite('ha000_08', 7)	# 37550-37556
    sprite('ha000_09', 7)	# 37557-37563
    sprite('ha000_10', 7)	# 37564-37570
    sprite('ha000_11', 7)	# 37571-37577
    gotoLabel(1002)
