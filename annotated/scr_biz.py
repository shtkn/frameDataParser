...
def MatchInit():
    ...
    Unknown14015(-2000, 464000, -248000, 114000, 3000, 50)
    Move_EndRegister()
    ...
    Move_Input_(INPUT_PRESS_A)
    Unknown15012(1200)
    Unknown14015(0, 550000, -200000, 200000, 500, 0)
    Move_EndRegister()
    ...
    Move_Input_(INPUT_214)
    Move_Input_(INPUT_PRESS_B)
    Unknown14015(100000, 500000, -130000, 500000, 250, 0)
    Move_EndRegister()
    ...
    Unknown15013(0)
    Unknown15006(1)
    Unknown14015(7000, 266000, -123000, 755000, 200, 0)
    Move_EndRegister()
    ...
    Unknown14015(0, 650000, -150000, 200000, 150, 0)
    Move_EndRegister()
...
def CmnActAirOverDriveEnd():
    ...
    GFX_1('izef_armchange', 0)
    sprite('iz333_09', 3)	# 4-6	 **attackbox here**
    sprite('iz333_17', 3)	# 7-9
    sprite('iz333_18', 3)	# 10-12
...
def NmlAtk2C():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown2004(1, 0)
    sprite('iz236_00', 4)	# 1-4
    sprite('iz236_01', 4)	# 5-8
    sprite('iz236_02', 4)	# 9-12
    SFX_0('001_airbackdash_0')
    sprite('iz236_03', 3)	# 13-15
    ...
    sprite('iz236_04', 2)	# 16-17	 **attackbox here**
    GFX_0('Kakusei3CAuraFire', 0)
    GFX_1('izef_Drivelight_side', 0)
    SFX_0('004_swing_grap_1_2')
    sprite('iz236_05', 2)	# 18-19	 **attackbox here**
    sprite('iz236_04', 2)	# 20-21	 **attackbox here**
    GFX_1('izef_Drivelight_side', 0)
    Unknown1019(90)
    sprite('iz236_06', 3)	# 22-24
    Recovery()
    Unknown2063()
    ...
    Unknown1019(60)
    sprite('iz236_07', 3)	# 25-27
    Unknown1019(40)
    sprite('iz236_08', 3)	# 28-30
    Unknown1019(20)
    sprite('iz236_09', 4)	# 31-34
    sprite('iz236_10', 4)	# 35-38
    sprite('iz236_11', 3)	# 39-41
    sprite('iz236_12', 3)	# 42-44
    sprite('iz236_13', 2)	# 45-46
...
def CmnActInvincibleAttackAir():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3076(1010)
        Unknown3077(1010)
    sprite('iz413_00', 3)	# 1-3
    Unknown1084(1)
    sprite('iz413_01', 2)	# 4-5
    sprite('iz413_01', 1)	# 6-6
    sprite('iz413_02', 2)	# 7-8
    sprite('iz413_05', 2)	# 9-10
    SFX_3('izse_01')
    sprite('iz413_06', 2)	# 11-12
    SFX_0('010_swing_sword_2')
    GFX_0('izef_413_a', -1)
    tag_voice(1, 'biz202_0', 'biz202_1', 'biz202_2', '')
    Unknown14070('AN_CmnActInvincibleAttackAir_Ne')
    sprite('iz413_07', 3)	# 13-15	 **attackbox here**
    sprite('iz413_08', 4)	# 16-19
    setInvincible(0)
    if SLOT_51:
        Unknown14072('AN_CmnActInvincibleAttackAir_Ne')
    sprite('iz413_09', 4)	# 20-23
    sprite('iz413_10', 4)	# 24-27
    Unknown14074('AN_CmnActInvincibleAttackAir_Ne')
    sprite('iz413_11', 4)	# 28-31
    sprite('iz413_01', 4)	# 32-35
    Unknown1044()
    sprite('iz413_00', 4)	# 36-39
    sprite('iz020_05', 4)	# 40-43
    sprite('iz020_06', 4)	# 44-47
    label(0)
    sprite('iz020_07', 3)	# 48-50
    sprite('iz020_08', 3)	# 51-53
    gotoLabel(0)
    label(1)
    sprite('iz024_00', 3)	# 54-56
    Unknown1084(1)
    Unknown8000(100, 1, 1)
    sprite('iz024_01', 3)	# 57-59
    sprite('iz024_02', 4)	# 60-63
    sprite('iz024_03', 4)	# 64-67
    sprite('iz024_04', 4)	# 68-71
...
def Iai_Slash():
    ...
    StartMultihit()
    Recovery()
    sprite('iz402_08', 2)	# 17-18
    sprite('iz402_09', 2)	# 19-20
    Unknown14077(0)
    Unknown2063()
    sprite('iz402_10', 2)	# 21-22
    Unknown7015()
    Unknown3029(0)
    Unknown14074('Iai_Slash_Next')
    Unknown14074('Warp_D_LandHitOnly')
    sprite('iz402_11', 3)	# 23-25
    sprite('iz402_12', 3)	# 26-28
    sprite('iz402_13', 3)	# 29-31
    ExitState()
    label(0)
...
def Iai_Slash_Next():
    ...
    Unknown14077(0)
    sprite('iz403_08', 3)	# 35-37
    sprite('iz403_09', 3)	# 38-40
    sprite('iz403_10', 3)	# 41-43
...
def Iai_AntiAir_Next():
    ...
    sprite('iz406_06', 3)	# 50-52	 **attackbox here**
    tag_voice(1, 'biz208_0', 'biz208_1', 'biz208_2', '')
    Unknown2003(0)
    SFX_3('izse_01')
    physicsYImpulse(-80000)
...
def Warp_A_Air():
    ...
    SFX_0('001_airbackdash_0')
    EnableCollision(0)
    sprite('iz410_03', 3)	# 15-17
    Unknown3001(0)
    SFX_0('001_airbackdash_0')
    EnableCollision(0)
    setInvincible(1)
    sprite('iz410_03', 3)	# 18-20
    sprite('iz410_03', 1)	# 21-21
    sprite('iz410_03', 1)	# 22-22
    sprite('iz410_03', 1)	# 23-23
    sprite('iz410_03', 1)	# 24-24
...
def Warp_D_LandHitOnly():
    ...
    label(0)
    Unknown1086(22)
    sprite('iz409_10ex00', 1)	# 20-20
    teleportRelativeX(70000)
    teleportRelativeY(0)
    Unknown1084(1)
    Unknown2006()
    Unknown23015(5)
    sprite('iz409_10ex00', 2)	# 21-22
    ...
    Unknown3077(1010)
    setInvincible(0)
    sprite('iz409_11ex00', 2)	# 23-24
    sprite('iz409_12ex00', 2)	# 25-26
    sprite('iz409_13ex00', 2)	# 27-28
    sprite('iz409_14ex00', 1)	# 29-29
    sprite('iz409_15ex00', 1)	# 30-30
...
def UltimateAssault():
    ...
    sprite('iz430_01', 3)	# 4-6
    sprite('iz430_02', 3)	# 7-9
    Unknown2036(78, -1, 0)
    ConsumeSuperMeter(-10000)
    Unknown30080('')
    sprite('iz430_03', 3)	# 10-12
    sprite('iz430_04', 3)	# 13-15
    sprite('iz430_02', 3)	# 16-18
    sprite('iz430_03', 3)	# 19-21
    SFX_3('izse_06')
    sprite('iz430_04', 3)	# 22-24
    sprite('iz430_02', 3)	# 25-27
    sprite('iz430_03', 3)	# 28-30
    sprite('iz430_04', 3)	# 31-33
    sprite('iz430_05', 3)	# 34-36
    GFX_0('DD_3d_zanzoh', 0)
    GFX_0('DD_pt_edge', 0)
    GFX_0('DD_pt_circle', 0)
    tag_voice(1, 'biz250_0', 'biz250_1', '', '')
    sprite('iz430_06', 3)	# 37-39
    sprite('iz430_07', 3)	# 40-42
    GFX_0('DD_3Dcircle_out', -1)
    GFX_0('DD_3Dcircle_in', -1)
    sprite('iz430_08', 3)	# 43-45
    sprite('iz430_09', 3)	# 46-48
    sprite('iz430_10', 3)	# 49-51
    sprite('iz430_11', 3)	# 52-54
    sprite('iz430_12', 3)	# 55-57
    sprite('iz430_13', 3)	# 58-60
    sprite('iz430_14', 2)	# 61-62
    sprite('iz430_15', 2)	# 63-64
    sprite('iz430_16', 4)	# 65-68
    sprite('iz430_17', 5)	# 69-73
    sprite('iz430_18', 18)	# 74-91
    sprite('iz430_18', 1)	# 92-92
    sprite('iz430_19ex00', 2)	# 93-94
...
def UltimateStrike():
    ...
    ConsumeSuperMeter(-10000)
    Unknown30080('')
    sprite('iz440_00', 3)	# 68-70
    sprite('iz440_01', 3)	# 71-73
    tag_voice(1, 'biz280_0', 'biz280_1', '', '')
    sprite('iz440_02', 2)	# 74-75
    sprite('iz440_03', 3)	# 76-78
    sprite('iz440_04', 1)	# 79-79
    sprite('iz440_04', 1)	# 80-80
    Unknown2015(200)
...
def CmnActChangePartnerIn():
    ...
    setGravity(0)
    sprite('iz252_01', 3)	# 28-30
    sprite('iz252_02', 3)	# 31-33
    sprite('iz252_03', 30)	# 34-63
    GFX_0('AIR5CZanzo', 0)
    label(9)
    sprite('iz252_04', 3)	# 64-66	 **attackbox here**
    SFX_0('019_cloth_a')
    EnableCollision(1)
    Unknown2053(1)
    Unknown1019(30)
    sprite('iz024_01', 3)	# 67-69
    Unknown8000(100, 1, 1)
    Unknown1084(1)
    Unknown26('AIR5CZanzo')
    sprite('iz024_02', 12)	# 70-81
    sprite('iz024_03', 3)	# 82-84
    sprite('iz024_04', 4)	# 85-88
