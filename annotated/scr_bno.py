...
def CmnActAirOverDriveEnd():
    sprite('no334_16', 4)	# 1-4
    sprite('no334_17', 4)	# 5-8
    sprite('no334_18', 4)	# 9-12
    sprite('no020_03', 3)	# 13-15
    sprite('no020_04', 3)	# 16-18
    sprite('no020_05', 3)	# 19-21
    label(0)
    sprite('no020_06', 3)	# 22-24
    sprite('no020_07', 3)	# 25-27
    loopRest()
    gotoLabel(0)
...
def CmnActAirCrossChangeEnd():
    sprite('keep', 4)	# 1-4
    sprite('no020_03', 3)	# 5-7
    sprite('no020_04', 3)	# 8-10
    sprite('no020_05', 3)	# 11-13
    label(0)
    sprite('no020_06', 3)	# 14-16
    sprite('no020_07', 3)	# 17-19
    loopRest()
    gotoLabel(0)
...
def NmlAtk4A():
    ...
    def upon_IMMEDIATE():
        ...
        HitOrBlockCancel('NmlAtkThrow')
        HitOrBlockCancel('NmlAtkBackThrow')
    sprite('no200_00', 2)	# 1-2
    Unknown1051(60)
    sprite('no200_01', 1)	# 3-3
    sprite('no200_01', 2)	# 4-5
    Unknown7009(0)
    sprite('no200_02', 3)	# 6-8	 **attackbox here**
    SFX_0('003_swing_grap_0_0')
    HitOrBlockJumpCancel(1)
    sprite('no200_03', 7)	# 9-15
    WhiffCancelEnable(1)
    Recovery()
    Unknown2063()
    sprite('no200_04', 5)	# 16-20
...
def Special236A():
    ...
    sprite('no202_02', 3)	# 5-7
    sprite('no202_03', 3)	# 8-10
    sprite('no202_04', 3)	# 11-13
    sprite('no202_05', 4)	# 14-17
    SFX_FOOTSTEP_(100, 1, 1)
    sprite('no202_06', 7)	# 18-24
    SFX_3('nose_00')
    GFX_0('BLT', 0)
    ...
    GFX_0('DIST_NO', 1)
    ScreenShake(0, 5000)
    sprite('no202_07', 5)	# 25-29
    sprite('no202_08', 5)	# 30-34
    sprite('no202_09', 6)	# 35-40
    Recovery()
    sprite('no202_10', 6)	# 41-46
    sprite('no202_11', 4)	# 47-50
    sprite('no202_12', 4)	# 51-54
...
def CmnActChangePartnerIn():
    ...
    setGravity(0)
    sprite('no293_00', 20)	# 9-28
    sprite('no293_01', 2)	# 29-30
    sprite('no293_02', 2)	# 31-32
    sprite('no293_03', 3)	# 33-35
    SFX_0('016_explode_1')
    GFX_0('noef_293', 2)
    Unknown2053(1)
    sprite('no293_04', 3)	# 36-38	 **attackbox here**
    GFX_0('BLT', 0)
    GFX_0('BLT', 1)
    sprite('no293_05', 3)	# 39-41
    sendToLabelUpon(2, 1)
    sprite('no293_06', 3)	# 42-44
    sprite('no293_07', 3)	# 45-47
    sprite('no293_08', 4)	# 48-51
    sprite('no293_09', 4)	# 52-55
    sprite('no293_10', 4)	# 56-59
    sprite('no020_05', 32767)	# 60-32826
    label(1)
    sprite('no024_01', 3)	# 32827-32829
    Unknown8000(100, 1, 1)
    Unknown1084(1)
    sprite('no024_02', 12)	# 32830-32841
    sprite('no024_03', 3)	# 32842-32844
    sprite('no024_04', 3)	# 32845-32847
...
def CmnActEntry():
    ...
    gotoLabel(992)
    label(993)
    sprite('no033_00', 1)	# 133529-133529
    ...
    setGravity(1500)
    Unknown8002()
    sprite('no033_01', 2)	# 133530-133531
    label(994)
    sprite('no033_02', 3)	# 133532-133534
    sprite('no033_03', 3)	# 133535-133537
    loopRest()
    gotoLabel(994)
    label(995)
    sprite('null', 3)	# 133538-133540
    ExitState()
