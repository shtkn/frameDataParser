...
def BurstDDMaster():
    ...
    ExitState()
    label(1)
    sprite('null', 14)	# 18-31
    sprite('null', 4)	# 32-35
    GFX_0('BurstDDEff', -1)
    GFX_0('BurstDDRevEff', -1)
    sprite('ph402_cutinRevex', 2)	# 36-37	 **attackbox here**
    sprite('ph402_cutinRev', 4)	# 38-41	 **attackbox here**
    sprite('ph402_cutinRev', 4)	# 42-45	 **attackbox here**
...
def DriveAtk_BRN():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 5001):
                ...
                Unknown2037(0)
                sendToLabel(1)
    sprite('vr_ph_magictest_ex', 10)	# 1-10	 **attackbox here**
    Unknown2037(5)
    GFX_0('Eff_BRN', -1)
    SFX_3('phse_04')
    GFX_1('phef_rbn_mc', -1)
    label(0)
    sprite('vr_ph_magictest_ex', 9)	# 11-19	 **attackbox here**
    RefreshMultihit()
    GFX_0('Eff_BRN', -1)
    teleportRelativeX(200000)
    if (SLOT_2 <= 4):
    ...
    if (SLOT_2 <= 1):
        teleportRelativeX(-30000)
    sprite('vr_ph_magictest_ex', 1)	# 20-20	 **attackbox here**
    if SLOT_2:
        Unknown2038(-1)
        sendToLabel(0)
    label(1)
...
def DriveAtk_GRN():
    ...
    sprite('phdrivecol_grn', 180)	# 5-184	 **attackbox here**
    Unknown2017(0)
    label(0)
    sprite('phdrivecol_grn', 20)	# 185-204	 **attackbox here**
    label(1)
    sprite('null', 10)	# 205-214
    clearUponHandler(42)
    clearUponHandler(14)
    clearUponHandler(11)
    clearUponHandler(43)
