...
def CmnActJumpLanding():
    sprite('rbl010_01', 2)	# 1-2
    sprite('rbl010_00', 2)	# 3-4
...
def CmnActAirOverDriveEnd():
    sprite('keep', 4)	# 1-4
    sprite('rbl333_09', 4)	# 5-8
    sprite('rbl333_10', 4)	# 9-12
    sprite('rbl020_04', 3)	# 13-15
    sprite('rbl020_05', 3)	# 16-18
    sprite('rbl020_06', 3)	# 19-21
    label(0)
    sprite('rbl020_07', 3)	# 22-24
    sprite('rbl020_08', 3)	# 25-27
    loopRest()
    gotoLabel(0)
...
def CmnActChangePartnerIn():
    ...
    setGravity(1000)
    sprite('rbl272_00', 3)	# 27-29
    sprite('rbl272_01', 3)	# 30-32
    sprite('rbl272_02', 3)	# 33-35
    sprite('rbl272_03', 3)	# 36-38	 **attackbox here**
    label(1)
    sprite('rbl272_03ex01', 3)	# 39-41	 **attackbox here**
    GFX_0('ShadowObjectBurst', -1)
    Unknown1019(30)
    sprite('rbl272_04', 3)	# 42-44
    Unknown1019(50)
    sprite('rbl272_05', 3)	# 45-47
    Unknown1019(50)
    sprite('rbl272_06', 4)	# 48-51
    Unknown1084(1)
    sprite('rbl272_07', 4)	# 52-55
    sprite('rbl272_08', 4)	# 56-59
    sprite('rbl272_09', 4)	# 60-63
...
def CmnActChangePartnerAssistAtk_B():
    ...
    gotoLabel(10)
    label(11)
    sprite('rbl010_00', 4)	# 57-60
    sprite('rbl010_01', 4)	# 61-64
    sprite('rbl010_00', 4)	# 65-68
...
def CmnActEntry():
    ...
    ExitState()
    label(991)
    sprite('rbl000_00', 1)	# 200026-200026
    Unknown2019(1000)
    Unknown21011(120)
    label(992)
    sprite('rbl000_00', 6)	# 200027-200032
    sprite('rbl000_01', 6)	# 200033-200038
    sprite('rbl000_02', 6)	# 200039-200044
    sprite('rbl000_03', 6)	# 200045-200050
    sprite('rbl000_04', 6)	# 200051-200056
    sprite('rbl000_05', 6)	# 200057-200062
    sprite('rbl000_06', 6)	# 200063-200068
    sprite('rbl000_07', 6)	# 200069-200074
    sprite('rbl000_08', 6)	# 200075-200080
    sprite('rbl000_09', 6)	# 200081-200086
    gotoLabel(992)
    label(993)
    sprite('rbl033_00', 3)	# 200087-200089
    ...
    Unknown8002()
    label(994)
    sprite('rbl033_01', 3)	# 200090-200092
    sprite('rbl033_02', 3)	# 200093-200095
    loopRest()
    gotoLabel(994)
    label(995)
    sprite('null', 3)	# 200096-200098
    ExitState()
    label(1000)
    sprite('rbl649_00', 5)	# 200099-200103
    Unknown1000(-200000)
    if (not SLOT_158):
        Unknown1000(-350000)
    ...
    def upon_43():
        if (SLOT_48 == 8001):
            clearUponHandler(43)
            sendToLabel(1002)
    sprite('rbl649_00', 5)	# 200104-200108
    sprite('rbl649_00', 5)	# 200109-200113
    label(1001)
    sprite('rbl649_00', 1)	# 200114-200114
    gotoLabel(1001)
    label(1002)
    sprite('rbl611_04', 6)	# 200115-200120
    SFX_1('rbl601')
    sprite('rbl611_05', 6)	# 200121-200126
    sprite('rbl611_06', 6)	# 200127-200132
    sprite('rbl611_07', 6)	# 200133-200138
    sprite('rbl611_08', 6)	# 200139-200144
    sprite('rbl611_09', 6)	# 200145-200150
    label(1003)
    sprite('rbl611_09', 1)	# 200151-200151
    if SLOT_97:
        _gotolabel(1003)
    sprite('rbl611_09', 20)	# 200152-200171
    Unknown23029(24, 8005, 0)
    Unknown23029(22, 8005, 0)
    Unknown23029(23, 8005, 0)
    sprite('rbl611_09', 6)	# 200172-200177
    ...
    def upon_43():
        ...
        if (SLOT_48 == 8008):
            sendToLabel(1005)
    label(1004)
    sprite('rbl611_09', 5)	# 200178-200182
    gotoLabel(1004)
    label(1005)
    sprite('rbl600_04', 5)	# 200183-200187
    sprite('rbl600_05', 5)	# 200188-200192
    sprite('rbl600_06', 5)	# 200193-200197
    label(1006)
    sprite('rbl000_00', 6)	# 200198-200203
    sprite('rbl000_01', 6)	# 200204-200209
    sprite('rbl000_02', 6)	# 200210-200215
    sprite('rbl000_03', 6)	# 200216-200221
    sprite('rbl000_04', 6)	# 200222-200227
    sprite('rbl000_05', 6)	# 200228-200233
    sprite('rbl000_06', 6)	# 200234-200239
    sprite('rbl000_07', 6)	# 200240-200245
    sprite('rbl000_08', 6)	# 200246-200251
    sprite('rbl000_09', 6)	# 200252-200257
    gotoLabel(1006)
    ExitState()
