...
def CmnActAirOverDriveEnd():
    sprite('rg333_08', 4)	# 1-4
    sprite('rg333_09', 4)	# 5-8
    sprite('rg333_10', 4)	# 9-12
    label(0)
...
def CmnActAirCrossChangeEnd():
    sprite('rg332_08', 2)	# 1-2
    sprite('rg020_05', 2)	# 3-4
    sprite('rg020_06', 2)	# 5-6
    label(0)
    sprite('rg020_07', 4)	# 7-10
    sprite('rg020_08', 4)	# 11-14
    loopRest()
...
def CmnActChangePartnerIn():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_LANDING():
            ...
            sendToLabel(9)
    sprite('null', 25)	# 1-25
    sprite('rg414_06ex', 3)	# 26-28	 **attackbox here**
    Unknown1086(22)
    ...
    Unknown2017(1)
    label(1)
    sprite('rg414_06ex', 3)	# 29-31	 **attackbox here**
    Unknown4048(90000)
    Unknown4049(1500)
    ...
    gotoLabel(1)
    label(9)
    sprite('rg414_07', 3)	# 35-37	 **attackbox here**
    Unknown1084(1)
    Unknown8000(-1, 1, 1)
    Unknown8004(100, 1, 1)
    ScreenShake(0, 5000)
    sprite('rg414_08', 5)	# 38-42
    sprite('rg414_09', 5)	# 43-47
    sprite('rg414_10', 3)	# 48-50
    sprite('rg414_11', 3)	# 51-53
    sprite('rg414_12', 3)	# 54-56
    sprite('rg414_13', 3)	# 57-59
...
def NmlAtk5AAAA():
    ...
    sprite('rg450_07', 4)	# 18-21	 **attackbox here**
    RefreshMultihit()
...
def NmlAtk5BBB():
    ...
    sprite('rg032_10', 3)	# 20-22
    WhiffCancelEnable(0)
    Unknown1019(50)
    sprite('rg032_11', 3)	# 23-25
...
def NmlAtk2A():
    ...
    sprite('rg231_02', 2)	# 5-6
    sprite('rg231_03', 2)	# 7-8
    sprite('rg231_04', 2)	# 9-10	 **attackbox here**
    sprite('rg231_05', 3)	# 11-13
    Recovery()
    Unknown2063()
    sprite('rg231_06', 3)	# 14-16
    sprite('rg231_07', 3)	# 17-19
    sprite('rg231_08', 3)	# 20-22
    sprite('rg231_09', 3)	# 23-25
...
def NmlAtk2B():
    ...
    def upon_IMMEDIATE():
        ...
        HitOrBlockCancel('CmnActCrushAttack')
        HitOrBlockJumpCancel(1)
    sprite('rg234_00', 2)	# 1-2
    sprite('rg234_01', 2)	# 3-4
    sprite('rg234_02', 2)	# 5-6
    Unknown7009(2)
    sprite('rg234_03', 2)	# 7-8
    sprite('rg234_04', 1)	# 9-9
    physicsXImpulse(15000)
    SFX_0('004_swing_grap_1_2')
    sprite('rg234_05', 1)	# 10-10
    sprite('rg234_06', 1)	# 11-11
    sprite('rg234_07', 3)	# 12-14	 **attackbox here**
    physicsXImpulse(0)
    sprite('rg234_08', 3)	# 15-17
    Recovery()
    Unknown2063()
    sprite('rg234_09', 3)	# 18-20
    sprite('rg234_10', 3)	# 21-23
    SFX_0('019_cloth_a')
    sprite('rg234_11', 2)	# 24-25
    sprite('rg234_12', 2)	# 26-27
    sprite('rg234_13', 2)	# 28-29
    sprite('rg234_14', 2)	# 30-31
    sprite('rg234_15', 2)	# 32-33
    sprite('rg234_16', 2)	# 34-35
...
def CmnActEntry():
    ...
    ExitState()
    label(991)
    sprite('rg000_00', 1)	# 135951-135951
    Unknown2019(1000)
    Unknown21011(120)
    label(992)
    sprite('rg000_00', 7)	# 135952-135958
    sprite('rg000_01', 7)	# 135959-135965
    sprite('rg000_02', 7)	# 135966-135972
    sprite('rg000_03', 7)	# 135973-135979
    sprite('rg000_04', 7)	# 135980-135986
    sprite('rg000_05', 7)	# 135987-135993
    sprite('rg000_06', 7)	# 135994-136000
    sprite('rg000_05', 7)	# 136001-136007
    sprite('rg000_04', 7)	# 136008-136014
    sprite('rg000_03', 7)	# 136015-136021
    sprite('rg000_02', 7)	# 136022-136028
    sprite('rg000_01', 7)	# 136029-136035
    gotoLabel(992)
    label(993)
    sprite('rg033_00', 1)	# 136036-136036
    ...
    Unknown8002()
    SFX_3('rgse_00')
    sprite('rg033_01', 2)	# 136037-136038
    label(994)
    sprite('rg033_02', 3)	# 136039-136041
    sprite('rg033_03', 3)	# 136042-136044
    loopRest()
    gotoLabel(994)
    label(995)
    sprite('null', 3)	# 136045-136047
    ExitState()
