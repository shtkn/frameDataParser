...
def CmnActAirCrossRushEnd():
    sprite('pt333_16', 4)	# 1-4
    sprite('pt333_17', 4)	# 5-8
    sprite('pt333_18', 4)	# 9-12
    label(0)
...
def CmnActChangePartnerIn():
    ...
    if SLOT_5:
        ...
        sendToLabel(1)
    label(1)
    sprite('pt255_04', 3)	# 7-9	 **attackbox here**
    SFX_0('003_swing_grap_0_2')
    sprite('pt255_05', 3)	# 10-12	 **attackbox here**
    sprite('pt255_06', 3)	# 13-15	 **attackbox here**
    sprite('pt255_07', 3)	# 16-18	 **attackbox here**
    SFX_0('003_swing_grap_0_2')
    sprite('pt255_08', 3)	# 19-21	 **attackbox here**
    sprite('pt255_09', 3)	# 22-24	 **attackbox here**
    loopRest()
    gotoLabel(1)
    label(5)
    sprite('pt255_10', 3)	# 25-27	 **attackbox here**
    clearUponHandler(2)
    Unknown2006()
    Unknown1084(1)
    SFX_3('ptse_02')
    ...
    sprite('pt255_11', 4)	# 28-31	 **attackbox here**
    StartMultihit()
    GFX_1('ptef_204dellight00', 0)
    GFX_1('ptef_204dellight00', 1)
    GFX_1('ptef_204dellight00', 2)
    sprite('pt255_12', 5)	# 32-36
    GFX_1('ptef_204dellight', 0)
    GFX_1('ptef_204dellight', 1)
    GFX_1('ptef_204dellight', 2)
    Recovery()
    sprite('pt255_13', 4)	# 37-40
    sprite('pt255_14', 4)	# 41-44
    sprite('pt255_15', 5)	# 45-49
    ExitState()
    label(100)
    sprite('keep', 1)	# 50-50
    sendToLabelUpon(2, 105)
    label(101)
    sprite('pt255_18', 3)	# 51-53	 **attackbox here**
    SFX_0('005_swing_grap_2_1')
    sprite('pt255_19', 3)	# 54-56	 **attackbox here**
    sprite('pt255_20', 3)	# 57-59	 **attackbox here**
    sprite('pt255_21', 3)	# 60-62	 **attackbox here**
    SFX_0('005_swing_grap_2_1')
    sprite('pt255_22', 3)	# 63-65	 **attackbox here**
    sprite('pt255_17', 3)	# 66-68	 **attackbox here**
    loopRest()
    gotoLabel(101)
    label(105)
    sprite('pt255_23', 3)	# 69-71	 **attackbox here**
    clearUponHandler(2)
    Unknown2006()
    Unknown1084(1)
    ...
    sprite('pt255_24', 4)	# 72-75	 **attackbox here**
    StartMultihit()
    GFX_1('ptef_204dellight00', 0)
    GFX_1('ptef_204dellight00', 1)
    GFX_1('ptef_204dellight00', 2)
    GFX_1('ptef_204dellight00', 3)
    sprite('pt255_12', 4)	# 76-79
    sprite('pt255_13', 4)	# 80-83
    GFX_1('ptef_204dellight', 0)
    GFX_1('ptef_204dellight', 1)
    GFX_1('ptef_204dellight', 2)
    GFX_1('ptef_204dellight', 3)
    GFX_1('ptef_204dellight', 4)
    sprite('pt255_14', 4)	# 84-87
    sprite('pt255_15', 5)	# 88-92
    loopRest()
...
def CmnActChangePartnerAssistAtk_B():
    ...
    label(1)
    sprite('pt023_00', 2)	# 2-3
    sprite('pt023_01', 2)	# 4-5
    Unknown11058('0100000000000000000000000000000000000000')
    sprite('pt020_00', 4)	# 6-9
    ...
    def upon_3():
        if (SLOT_19 <= 250000):
            clearUponHandler(3)
            Unknown1019(25)
    sprite('pt020_01', 4)	# 10-13
    sprite('pt020_01', 4)	# 14-17
    sprite('pt020_02', 1)	# 18-18
    sprite('pt255_00', 3)	# 19-21
    if SLOT_58:
        sendToLabel(11)
    sprite('pt255_01', 2)	# 22-23
    AttackLevel_(5)
    Damage(1500)
    AttackP2(80)
    Unknown11092(1)
    ...
    setGravity(10)
    sprite('pt255_02', 3)	# 24-26
    sprite('pt255_03', 3)	# 27-29
    if (not SLOT_7):
        SFX_1('bpt302_0')
    else:
        SFX_1('bpt302_1')
    ...
    sprite('pt255_04', 3)	# 48-50	 **attackbox here**
    loopRest()
    gotoLabel(101)
    label(102)
    sprite('pt255_10', 4)	# 51-54	 **attackbox here**
    Unknown2006()
    RefreshMultihit()
    ...
    Unknown8000(100, 1, 1)
    GFX_1('ptef_airhammerDwave', -1)
    sprite('pt255_11', 9)	# 55-63	 **attackbox here**
    StartMultihit()
    GFX_1('ptef_204dellight00', 0)
    GFX_1('ptef_204dellight00', 1)
    GFX_1('ptef_204dellight00', 2)
    sprite('pt255_12', 4)	# 64-67
    GFX_1('ptef_204dellight', 0)
    GFX_1('ptef_204dellight', 1)
    GFX_1('ptef_204dellight', 2)
    Recovery()
    callSubroutine('StuffColorReset')
    sprite('pt255_13', 4)	# 68-71
    sprite('pt255_14', 4)	# 72-75
    sprite('pt255_15', 5)	# 76-80
    ExitState()
    label(11)
    sprite('pt255_01', 2)	# 81-82
    AttackLevel_(5)
    Damage(1800)
    AttackP2(90)
    Unknown11092(1)
    ...
    physicsYImpulse(1000)
    setGravity(10)
    sprite('pt255_02', 3)	# 83-85
    sprite('pt255_16', 3)	# 86-88
    if (not SLOT_7):
        SFX_1('bpt304_0')
    else:
        SFX_1('bpt304_1')
    Unknown1084(1)
    Unknown1019(25)
    sprite('pt255_17', 3)	# 89-91	 **attackbox here**
    setGravity(2000)
    label(111)
    sprite('pt255_18', 3)	# 92-94	 **attackbox here**
    SFX_0('005_swing_grap_2_1')
    sprite('pt255_19', 3)	# 95-97	 **attackbox here**
    sprite('pt255_20', 3)	# 98-100	 **attackbox here**
    sprite('pt255_21', 3)	# 101-103	 **attackbox here**
    SFX_0('005_swing_grap_2_1')
    sprite('pt255_22', 3)	# 104-106	 **attackbox here**
    sprite('pt255_17', 3)	# 107-109	 **attackbox here**
    loopRest()
    gotoLabel(111)
    label(112)
    sprite('pt255_23', 4)	# 110-113	 **attackbox here**
    Unknown2006()
    RefreshMultihit()
    GroundedHitstunAnimation(9)
    PushbackX(39900)
    ...
    GFX_1('ptef_hammerDshock', 0)
    ScreenShake(0, 50000)
    sprite('pt255_24', 9)	# 114-122	 **attackbox here**
    if (not SLOT_53):
    ...
    GFX_1('ptef_204dellight00', 3)
    Recovery()
    sprite('pt255_12', 4)	# 123-126
    sprite('pt255_13', 4)	# 127-130
    GFX_1('ptef_204dellight', 0)
    GFX_1('ptef_204dellight', 1)
    GFX_1('ptef_204dellight', 2)
    GFX_1('ptef_204dellight', 3)
    GFX_1('ptef_204dellight', 4)
    sprite('pt255_14', 4)	# 131-134
    sprite('pt255_15', 5)	# 135-139
    ExitState()
    label(2)
    sprite('pt204_00', 1)	# 140-140
    sprite('pt204_01', 1)	# 141-141
    ...
    Unknown9118(50)
    Unknown11050('06000000707465665f6869745f6d6964646c650000000000000000000000000000000000')
    sprite('pt206_01', 2)	# 146-147
    sprite('pt206_01', 1)	# 148-148
    physicsXImpulse(35000)
    sprite('pt206_02', 1)	# 149-149
    if (not SLOT_7):
        SFX_1('bpt305_0')
    else:
        SFX_1('bpt305_1')
    sprite('pt206_03', 8)	# 150-157	 **attackbox here**
    Unknown1084(1)
    ...
    Unknown9118(50)
    Unknown11050('06000000707465665f6869745f6d6964646c650000000000000000000000000000000000')
    sprite('pt206_07', 2)	# 181-182
    sprite('pt206_07', 1)	# 183-183
    physicsXImpulse(35000)
    sprite('pt206_08', 1)	# 184-184
    if (not SLOT_7):
        SFX_1('bpt307_0')
    else:
        SFX_1('bpt307_1')
    sprite('pt206_09', 8)	# 185-192	 **attackbox here**
    Unknown1084(1)
    SFX_0('005_swing_grap_2_2')
    SFX_3('ptse_07')
    ...
    sprite('pt204_12', 2)	# 210-211
    sprite('pt204_13', 2)	# 212-213
    ExitState()
    label(3)
    ...
    def upon_3():
        ...
        if op(5, 2, 0, 2, 52):
            clearUponHandler(3)
            sendToLabel(14)
    sprite('pt404_00', 2)	# 214-215
    physicsXImpulse(-8000)
    sprite('pt404_00', 3)	# 216-218
    physicsXImpulse(0)
    sprite('pt404_01', 2)	# 219-220
    sprite('pt404_02', 2)	# 221-222
    Unknown8006(100, 1, 1)
    physicsXImpulse(34000)
    SFX_0('000_airdash_0')
    SFX_3('ptse_23')
    sprite('pt404_03', 2)	# 223-224
    SLOT_52 = 1
    sprite('pt404_04', 2)	# 225-226
    sprite('pt404_02', 2)	# 227-228
    sprite('pt404_03', 2)	# 229-230
    sprite('pt404_04', 2)	# 231-232
    sprite('pt404_02', 2)	# 233-234
    sprite('pt404_03', 2)	# 235-236
    sprite('pt404_04', 2)	# 237-238
    sprite('pt404_02', 2)	# 239-240
    sprite('pt404_03', 2)	# 241-242
    sprite('pt404_04', 2)	# 243-244
    label(14)
    sprite('pt205_00', 2)	# 245-246
    clearUponHandler(3)
    Unknown1084(1)
    Unknown1047(9000)
    ...
    sprite('pt207_00', 2)	# 251-252
    sprite('pt207_00', 1)	# 253-253
    sprite('pt207_01', 2)	# 254-255	 **attackbox here**
    if (not SLOT_7):
        SFX_1('bpt309_0')
    else:
        SFX_1('bpt309_1')
    ...
    SFX_0('003_swing_grap_0_2')
    sprite('pt207_02', 2)	# 256-257	 **attackbox here**
    sprite('pt207_03', 2)	# 258-259	 **attackbox here**
    GFX_1('ptef_207dellight00', 0)
    GFX_1('ptef_207dellight00', 1)
    GFX_1('ptef_lightrod00', 0)
    GFX_1('ptef_lightrod00', 1)
    sprite('pt207_04', 5)	# 260-264
    GFX_1('ptef_207dellight', 0)
    GFX_1('ptef_207dellight', 1)
    Recovery()
    sprite('pt205_07ex01', 3)	# 265-267	 **attackbox here**
    callSubroutine('StuffColorReset')
    sprite('pt205_08', 4)	# 268-271
    sprite('pt205_09', 3)	# 272-274
    sprite('pt205_10', 3)	# 275-277
    ExitState()
    label(13)
    sprite('pt205_01', 3)	# 278-280
    AttackLevel_(4)
    Damage(2040)
    AttackP2(85)
    GroundedHitstunAnimation(2)
    ...
    sprite('pt207_05', 2)	# 281-282
    sprite('pt207_05', 1)	# 283-283
    sprite('pt207_06', 2)	# 284-285	 **attackbox here**
    if (not SLOT_7):
        SFX_1('bpt311_0')
    else:
        SFX_1('bpt311_1')
    SFX_0('004_swing_grap_1_1')
    SFX_0('003_swing_grap_0_2')
    sprite('pt207_07', 2)	# 286-287	 **attackbox here**
    sprite('pt207_08', 2)	# 288-289	 **attackbox here**
    GFX_1('ptef_207dellight00', 1)
    GFX_1('ptef_207dellight00', 2)
    GFX_1('ptef_lightrod00', 0)
    GFX_1('ptef_lightrod00', 1)
    GFX_1('ptef_lightrod00', 2)
    sprite('pt207_09', 5)	# 290-294
    GFX_1('ptef_207dellight', 0)
    GFX_1('ptef_207dellight', 1)
    Recovery()
    sprite('pt205_07ex01', 3)	# 295-297	 **attackbox here**
    callSubroutine('StuffColorReset')
    sprite('pt205_08', 4)	# 298-301
    sprite('pt205_09', 3)	# 302-304
    sprite('pt205_10', 3)	# 305-307
    ExitState()
    label(4)
    sprite('pt023_00', 2)	# 308-309
    sprite('pt023_01', 2)	# 310-311
    sprite('pt020_00', 1)	# 312-312
    physicsXImpulse(21000)
    physicsYImpulse(32200)
    Unknown1043()
    sprite('pt256_00', 1)	# 313-313
    clearUponHandler(2)
    sendToLabelUpon(2, 145)
    sprite('keep', 1)	# 314-314
    if SLOT_58:
        sendToLabel(14)
    sprite('pt256_01', 1)	# 315-315
    AttackLevel_(3)
    ...
    Unknown1084(1)
    sprite('pt256_01', 3)	# 316-318
    physicsYImpulse(16000)
    physicsXImpulse(8000)
    setGravity(1850)
    Unknown22004(7, 1)
    sprite('pt256_02', 3)	# 319-321
    if (not SLOT_7):
        SFX_1('bpt314_0')
    else:
        SFX_1('bpt314_1')
    sprite('pt256_03', 1)	# 322-322	 **attackbox here**
    callSubroutine('ItemConsume')
    SFX_0('005_swing_grap_2_2')
    sprite('pt256_03', 2)	# 323-324	 **attackbox here**
    sprite('pt256_04', 1)	# 325-325	 **attackbox here**
    GFX_1('ptef_lightrod00', 0)
    GFX_1('ptef_lightrod00', 1)
    GFX_1('ptef_lightrod00', 2)
    sprite('pt256_04', 4)	# 326-329	 **attackbox here**
    sprite('pt256_05', 2)	# 330-331
    Unknown1043()
    sprite('pt256_06', 4)	# 332-335
    GFX_1('ptef_205dellight', 0)
    GFX_1('ptef_205dellight', 1)
    GFX_1('ptef_205dellight', 2)
    sprite('pt256_07', 3)	# 336-338
    sprite('pt256_08', 3)	# 339-341
    sprite('pt256_09', 4)	# 342-345
    sprite('pt256_10', 3)	# 346-348
    sprite('pt256_11', 3)	# 349-351
    sendToLabel(140)
    label(14)
    sprite('pt256_01', 1)	# 352-352
    AttackLevel_(4)
    GroundedHitstunAnimation(13)
    AirHitstunAnimation(13)
    AirPushbackX(65000)
    ...
    Unknown1084(1)
    sprite('pt256_01', 3)	# 353-355
    physicsYImpulse(16000)
    physicsXImpulse(2000)
    setGravity(1850)
    Unknown22004(7, 1)
    sprite('pt256_12', 3)	# 356-358
    if (not SLOT_7):
        SFX_1('bpt316_0')
    else:
        SFX_1('bpt316_1')
    sprite('pt256_13', 1)	# 359-359	 **attackbox here**
    callSubroutine('ItemConsume')
    SFX_0('005_swing_grap_2_2')
    sprite('pt256_13', 4)	# 360-363	 **attackbox here**
    sprite('pt256_14', 5)	# 364-368	 **attackbox here**
    GFX_1('ptef_lightrod00', 0)
    GFX_1('ptef_lightrod00', 1)
    GFX_1('ptef_lightrod00', 2)
    sprite('pt256_15', 1)	# 369-369
    Unknown1043()
    sprite('pt256_16', 4)	# 370-373
    GFX_1('ptef_205dellight00', 0)
    GFX_1('ptef_205dellight00', 1)
    GFX_1('ptef_205dellight00', 2)
    sprite('pt256_07', 3)	# 374-376
    sprite('pt256_08', 3)	# 377-379
    sprite('pt256_09', 4)	# 380-383
    sprite('pt256_10', 3)	# 384-386
    sprite('pt256_11', 3)	# 387-389
    label(140)
    sprite('pt020_05', 3)	# 390-392
    sprite('pt020_06', 3)	# 393-395
    label(141)
    sprite('pt020_07', 4)	# 396-399
    sprite('pt020_08', 4)	# 400-403
    loopRest()
    gotoLabel(141)
    label(145)
    sprite('pt024_00', 2)	# 404-405
    Unknown1084(1)
    Unknown8000(100, 1, 1)
    sprite('pt024_01', 4)	# 406-409
    sprite('pt024_02', 3)	# 410-412
...
def NmlAtk2A():
    ...
    def upon_IMMEDIATE():
        ...
        HitOrBlockCancel('NmlAtkThrow')
        HitOrBlockCancel('NmlAtkBackThrow')
    sprite('pt230_00', 4)	# 1-4
    Unknown1051(60)
    sprite('pt230_01', 3)	# 5-7
    sprite('pt230_02', 3)	# 8-10	 **attackbox here**
    SFX_0('007_swing_knife_0')
    Unknown7009(0)
    sprite('pt230_03', 3)	# 11-13
    WhiffCancelEnable(1)
    Recovery()
    Unknown2063()
    sprite('pt230_04', 4)	# 14-17
    sprite('pt230_05', 3)	# 18-20
...
def HoppingPlus_A():
    ...
    label(2)
    sprite('pt020_07', 3)	# 32802-32804
    sprite('pt020_08', 3)	# 32805-32807
    gotoLabel(2)
...
def HoppingPlus_B():
    ...
    label(2)
    sprite('pt020_07', 3)	# 65-67
    sprite('pt020_08', 3)	# 68-70
    gotoLabel(2)
...
def CmnActEntry():
    ...
    ExitState()
    label(991)
    sprite('pt000_00', 1)	# 101940-101940
    Unknown2019(1000)
    Unknown21011(120)
    label(992)
    sprite('pt000_00', 7)	# 101941-101947
    sprite('pt000_01', 7)	# 101948-101954
    sprite('pt000_02', 7)	# 101955-101961
    sprite('pt000_03', 7)	# 101962-101968
    sprite('pt000_04', 7)	# 101969-101975
    sprite('pt000_05', 7)	# 101976-101982
    sprite('pt000_06', 7)	# 101983-101989
    sprite('pt000_07', 7)	# 101990-101996
    sprite('pt000_08', 7)	# 101997-102003
    sprite('pt000_09', 7)	# 102004-102010
    sprite('pt000_10', 7)	# 102011-102017
    sprite('pt000_11', 7)	# 102018-102024
    sprite('pt000_12', 7)	# 102025-102031
    sprite('pt000_13', 7)	# 102032-102038
    gotoLabel(992)
    label(993)
    sprite('pt033_00', 2)	# 102039-102040
    ...
    setGravity(1500)
    Unknown8002()
    sprite('pt033_01', 3)	# 102041-102043
    label(994)
    sprite('pt033_02', 3)	# 102044-102046
    sprite('pt033_01', 3)	# 102047-102049
    loopRest()
    gotoLabel(994)
    label(995)
    sprite('null', 3)	# 102050-102052
    ExitState()
    label(1000)
    sprite('pt000_00', 1)	# 102053-102053
    Unknown1000(-200000)
    if (not SLOT_158):
        Unknown1000(-350000)
    ...
    def upon_43():
        ...
        if (SLOT_48 == 10004):
            ...
            sendToLabel(1004)
    label(1001)
    sprite('pt000_00', 7)	# 102054-102060
    sprite('pt000_01', 7)	# 102061-102067
    sprite('pt000_02', 7)	# 102068-102074
    sprite('pt000_03', 7)	# 102075-102081
    sprite('pt000_04', 7)	# 102082-102088
    sprite('pt000_05', 7)	# 102089-102095
    sprite('pt000_06', 7)	# 102096-102102
    sprite('pt000_07', 7)	# 102103-102109
    sprite('pt000_08', 7)	# 102110-102116
    sprite('pt000_09', 7)	# 102117-102123
    sprite('pt000_10', 7)	# 102124-102130
    sprite('pt000_11', 7)	# 102131-102137
    sprite('pt000_12', 7)	# 102138-102144
    sprite('pt000_13', 7)	# 102145-102151
    gotoLabel(1001)
    label(1002)
    sprite('pt070_13', 6)	# 102152-102157
    sprite('pt070_12', 6)	# 102158-102163
    sprite('pt070_11', 6)	# 102164-102169
    label(1003)
    sprite('pt650_00', 1)	# 102170-102170
    if SLOT_97:
        _gotolabel(1003)
    sprite('pt650_00', 20)	# 102171-102190
    sprite('pt650_00', 32767)	# 102191-134957
    Unknown23029(24, 10003, 0)
    Unknown23029(22, 10003, 0)
    Unknown23029(23, 10003, 0)
    label(1004)
    sprite('pt070_10', 6)	# 134958-134963
    sprite('pt070_11', 6)	# 134964-134969
    sprite('pt070_12', 6)	# 134970-134975
    sprite('pt070_13', 6)	# 134976-134981
    sprite('pt203_00', 1)	# 134982-134982
    sprite('pt203_01', 2)	# 134983-134984
    sprite('pt203_02', 2)	# 134985-134986
    GFX_0('pt203_mahojin', -1)
    GFX_0('pt203_mahojinsub', -1)
    GFX_0('pt203_aura1', -1)
    GFX_0('pt203_aura2', -1)
    GFX_0('pt203_aura3', -1)
    sprite('pt203_02', 2)	# 134987-134988
    sprite('pt203_03', 1)	# 134989-134989
    GFX_0('pt203_stick', 0)
    sprite('pt203_04', 2)	# 134990-134991
    SFX_3('ptse_13')
    sprite('pt203_05', 5)	# 134992-134996
    sprite('pt203_06', 2)	# 134997-134998
    sprite('pt203_07', 2)	# 134999-135000
    sprite('pt203_08', 2)	# 135001-135002
    sprite('pt203_09', 2)	# 135003-135004
    sprite('pt203_10', 2)	# 135005-135006
    sprite('pt203_11', 1)	# 135007-135007
    Unknown18008()
    label(1005)
    sprite('pt000_00', 7)	# 135008-135014
    sprite('pt000_01', 7)	# 135015-135021
    sprite('pt000_02', 7)	# 135022-135028
    sprite('pt000_03', 7)	# 135029-135035
    sprite('pt000_04', 7)	# 135036-135042
    sprite('pt000_05', 7)	# 135043-135049
    sprite('pt000_06', 7)	# 135050-135056
    sprite('pt000_07', 7)	# 135057-135063
    sprite('pt000_08', 7)	# 135064-135070
    sprite('pt000_09', 7)	# 135071-135077
    sprite('pt000_10', 7)	# 135078-135084
    sprite('pt000_11', 7)	# 135085-135091
    sprite('pt000_12', 7)	# 135092-135098
    sprite('pt000_13', 7)	# 135099-135105
    gotoLabel(1005)
