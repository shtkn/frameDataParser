...
def maef_001_zanzou2():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3033()
        Unknown3001(197)
    sprite('vrmaef001_10', 4)	# 1-4
    sprite('vrmaef001_11', 20)	# 5-24
    callSubroutine('Zanzou_Color')
...
def maef_202():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(1)
        Unknown3033()
    sprite('vrmaef202_01', 2)	# 1-2
    sprite('vrmaef202_02', 2)	# 3-4
    sprite('vrmaef202_03', 2)	# 5-6
...
def maef_202_2():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef202_04', 4)	# 1-4
    teleportRelativeX(-64000)
    sprite('vrmaef202_05', 12)	# 5-16
...
def maef_232():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef232_04', 4)	# 1-4
    sprite('vrmaef232_05', 12)	# 5-16
...
def maef_540():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef540_03', 2)	# 1-2
    teleportRelativeX(-64000)
    sprite('vrmaef540_04', 16)	# 3-18
    teleportRelativeX(64000)
...
def maef_252():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef252_04', 4)	# 1-4
    Unknown3004(-16)
    sprite('vrmaef252_05', 3)	# 5-7
    sprite('vrmaef252_06', 3)	# 8-10
...
def maef_531():
    ...
    def upon_IMMEDIATE():
        ...
        callSubroutine('Zanzou_Color')
        teleportRelativeX(64000)
    sprite('vrmaef531_00', 4)	# 1-4
    GFX_0('maef_531_smash', 0)
    sprite('vrmaef531_01', 20)	# 5-24
...
def maef_503():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(1)
        Unknown3033()
    sprite('vrmaef503_00', 3)	# 1-3
    sprite('vrmaef503_01', 4)	# 4-7
    GFX_0('maef_503_particle', 0)
    sprite('vrmaef503_02', 4)	# 8-11
...
def maef_340():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef340_00', 3)	# 1-3
    sprite('vrmaef340_01', 3)	# 4-6
...
def maef_501_zanzou():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef501_00', 5)	# 1-5
    callSubroutine('Zanzou_Color')
    sprite('vrmaef501_01', 16)	# 6-21
    callSubroutine('Zanzou_Color')
...
def maef_501_zanzou2():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef501_00', 7)	# 1-7
    callSubroutine('Zanzou_Color')
    sprite('vrmaef501_01', 16)	# 8-23
    callSubroutine('Zanzou_Color')
...
def maef_501_atk1():
    ...
    sprite('null', 3)	# 1-3
    sprite('vrmaef501atk', 3)	# 4-6
    StartMultihit()
    teleportRelativeX(50000)
    GFX_0('maef_501', -1)
    Unknown38(4, 1)
    SFX_3('mase_00')
    sprite('vrmaef501atk', 6)	# 7-12
    physicsXImpulse(60000)
    sprite('vrmaef501atk', 5)	# 13-17
    Unknown1019(60)
    sprite('vrmaef501atk', 5)	# 18-22
    Unknown1019(60)
    sprite('vrmaef501atk', 5)	# 23-27
    Unknown1019(60)
    Unknown23029(4, 5000, 0)
    Unknown23027()
    sprite('vrmaef501atk', 10)	# 28-37
    Unknown1019(20)
    label(580)
    sprite('vrmaef501atk', 10)	# 38-47
    clearUponHandler(54)
    Unknown13(4)
    Unknown1084(1)
    Unknown23027()
...
def maef_501_atk2():
    ...
    Unknown38(4, 1)
    SFX_3('mase_00')
    sprite('vrmaef501atk', 12)	# 7-18
    physicsXImpulse(60000)
    sprite('vrmaef501atk', 5)	# 19-23
    Unknown1019(60)
    sprite('vrmaef501atk', 5)	# 24-28
    Unknown1019(60)
    sprite('vrmaef501atk', 5)	# 29-33
    Unknown1019(60)
    Unknown23029(4, 5000, 0)
    Unknown23027()
    sprite('vrmaef501atk', 10)	# 34-43
    Unknown1019(20)
    label(580)
    sprite('vrmaef501atk', 10)	# 44-53
    clearUponHandler(54)
    Unknown13(4)
    Unknown1084(1)
    Unknown23027()
    ...
    def upon_IMMEDIATE():
        ...
        def upon_43():
            if (SLOT_48 == 5000):
                ...
                Unknown3001(128)
                Unknown23029(4, 5000, 0)
    sprite('vrmaef_shot00', 2)	# 1-2
    GFX_0('maef_501_Shot', -1)
    Unknown38(4, 1)
    sprite('vrmaef_shot01', 2)	# 3-4
    sprite('vrmaef_shot02', 2)	# 5-6
    GFX_0('maef_501_Shot_aura', -1)
    label(0)
    sprite('vrmaef_shot00', 2)	# 7-8
    sprite('vrmaef_shot01', 2)	# 9-10
    sprite('vrmaef_shot02', 2)	# 11-12
    gotoLabel(0)
...
def maef_530():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef530_00', 3)	# 1-3
    GFX_0('maef_530_Particle', 0)
    sprite('vrmaef530_01', 4)	# 4-7
    sprite('vrmaef530_02', 12)	# 8-19
...
def maef_401():
    ...
    label(0)
    sprite('vrmaef401_01', 3)	# 4-6
    GFX_0('maef_401_aura', 0)
    GFX_0('maef_401_aura2', 0)
    GFX_0('maef_401_aura3', 0)
    sprite('vrmaef401_00', 3)	# 7-9
    GFX_0('maef_401_aura', 0)
    GFX_0('maef_401_aura2', 0)
    GFX_0('maef_401_aura3', 0)
    gotoLabel(0)
...
def maef431_jump():
    ...
    label(0)
    sprite('vrmaef431_13', 2)	# 9-10
    sprite('vrmaef431_12', 2)	# 11-12
    gotoLabel(0)
...
def maef431_tornade():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(1)
        Unknown1099(7)
    sprite('vrmaef431_30', 6)	# 1-6
    sprite('vrmaef431_31', 6)	# 7-12
    sprite('null', 1)	# 13-13
...
def maef431_fall():
    ...
    label(0)
    sprite('vrmaef431_21', 2)	# 3-4
    sprite('vrmaef431_20', 2)	# 5-6
    gotoLabel(0)
...
def maef431_crash_aura():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3033()
        Unknown4061(1)
    sprite('vrmaef431_40', 6)	# 1-6
    sprite('vrmaef431_41', 6)	# 7-12
    sprite('vrmaef431_42', 6)	# 13-18
    sprite('vrmaef431_43', 6)	# 19-24
...
def maef430_lance():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(1)
        Unknown3033()
    sprite('vrmaef430_00', 2)	# 1-2
    sprite('vrmaef430_02', 3)	# 3-5
    sprite('vrmaef430_03', 3)	# 6-8
    sprite('vrmaef430_10', 2)	# 9-10
    sprite('vrmaef430_11', 2)	# 11-12
...
def maef430_strike_anm():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4061(1)
        Unknown3033()
    sprite('vrmaef430_50', 6)	# 1-6
    sprite('vrmaef430_51', 20)	# 7-26
    Unknown3004(-12)
    Unknown1059(20)
...
def maef430_flower():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown3033()
        Unknown4061(1)
    sprite('vrmaef430_60', 16)	# 1-16
    GFX_0('maef430_flower_particle', -1)
    Unknown1099(10)
    sprite('vrmaef430_61', 8)	# 17-24
    sprite('vrmaef430_62', 8)	# 25-32
    Unknown4007(0)
    sprite('vrmaef430_63', 10)	# 33-42
    Unknown3004(-25)
...
def ma203Shot():
    ...
    def upon_IMMEDIATE():
        ...
        def upon_14():
            sendToLabel(580)
    sprite('ma203atk_dummy', 1)	# 1-1
    sprite('ma203atk_dummy', 1)	# 2-2
    if SLOT_7:
        Unknown1019(150)
        YAccel(150)
    label(0)
    sprite('ma203atk_dummy', 1)	# 3-3
    loopRest()
    gotoLabel(0)
    label(1)
    sprite('null', 1)	# 4-4
    ...
    def upon_ON_HIT_OR_BLOCK():
        ...
        Unknown21015('4e6d6c41746b4149523542326e64000000000000000000000000000000000000e803000000000000')
    label(2)
    sprite('ma203atk_dummy', 1)	# 6-6
    Unknown1019(105)
    YAccel(105)
    loopRest()
    gotoLabel(2)
    label(580)
    sprite('ma203atk_dummy', 1)	# 7-7
    clearUponHandler(43)
    clearUponHandler(3)
    clearUponHandler(10)
    clearUponHandler(11)
...
def AstralCamera():
    ...
    label(1)
    sprite('null', 20)	# 65535-65554
    physicsYImpulse(90000)
    sprite('null', 32767)	# 65555-98321
    Unknown1084(1)
    label(2)
    sprite('null', 5)	# 98322-98326
    Unknown1000(0)
    teleportRelativeY(0)
    Unknown1084(1)
    Unknown20001(1)
    Unknown20009(900)
    sprite('null', 10)	# 98327-98336
    Unknown23024(3)
    Unknown20001(0)
    Unknown1086(3)
    Unknown1007(250000)
    Unknown1084(1)
    sprite('null', 32767)	# 98337-131103
    GFX_0('maef_ah_Ryuhai', -1)
    SFX_0('000_airdash_0')
    label(3)
    sprite('null', 10)	# 131104-131113
    sprite('null', 5)	# 131114-131118
    Unknown23024(2)
    sprite('null', 10)	# 131119-131128
    Unknown23024(3)
    sprite('null', 32767)	# 131129-163895
    teleportRelativeY(2930000)
    Unknown20001(1)
    label(4)
    sprite('null', 50)	# 163896-163945
    physicsYImpulse(-50000)
    GFX_0('maef450_yari', -1)
    SFX_3('mase_10')
    SFX_3('mase_10')
    sprite('null', 10)	# 163946-163955
    physicsYImpulse(-4000)
    sprite('null', 10)	# 163956-163965
    physicsYImpulse(-2000)
    sprite('null', 40)	# 163966-164005
    physicsYImpulse(-1000)
    sprite('null', 40)	# 164006-164045
    Unknown1084(1)
    sprite('null', 30)	# 164046-164075
    SLOT_11 = 1
    sprite('null', 40)	# 164076-164115
    GFX_0('maef450_bomb', -1)
    sprite('null', 5)	# 164116-164120
    GFX_0('maef450_bomb2', -1)
    SFX_3('mase_11')
    SFX_0('016_explode_2')
    SFX_0('016_explode_2')
    sprite('null', 32767)	# 164121-196887
    GFX_0('maef450_cloud2', -1)
    GFX_0('maef450_cloud', -1)
    label(5)
    sprite('null', 30)	# 196888-196917
    Unknown1000(0)
    teleportRelativeY(0)
    GFX_0('maef_ah_killwhite', -1)
    Unknown23013(0)
    clearUponHandler(2)
    sprite('null', 32767)	# 196918-229684
...
def maef450_zanzou():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef450_00', 3)	# 1-3
    sprite('vrmaef450_01', 16)	# 4-19
...
def maef450_yari():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown1007(98000)
        Unknown4007(2)
    sprite('maef450_90', 6)	# 1-6
    sprite('maef450_91', 6)	# 7-12
    sprite('maef450_92', 6)	# 13-18
    GFX_0('maef450_yari_dust', -1)
    sprite('maef450_93', 7)	# 19-25
    sprite('maef450_94', 8)	# 26-33	 **attackbox here**
    sprite('maef450_95', 6)	# 34-39
    GFX_0('maef450_yari2_dust', -1)
    sprite('maef450_96', 4)	# 40-43
    sprite('maef450_97', 3)	# 44-46
    sprite('maef450_98', 3)	# 47-49
    sprite('null', 20)	# 50-69
    physicsYImpulse(-4000)
    sprite('null', 10)	# 70-79
    physicsYImpulse(-1000)
    sprite('null', 70)	# 80-149
    GFX_0('maef450_yari2', -1)
    sprite('null', 60)	# 150-209
...
def ma450yari_dummy():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown1000(0)
        teleportRelativeY(0)
    sprite('ma450yari_dummy', 32767)	# 1-32767
...
def maef_440():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(3)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef312_00', 3)	# 1-3
    sprite('vrmaef312_01', 15)	# 4-18
...
def maef_440_slash1():
    ...
    def upon_IMMEDIATE():
        Unknown4007(2)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef440_00', 4)	# 1-4
    sprite('vrmaef440_01', 10)	# 5-14
...
def maef_440_slash2():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(2)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef440_10', 4)	# 1-4
    sprite('vrmaef440_11', 10)	# 5-14
...
def maef_440_slash3():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(2)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef440_20', 4)	# 1-4
    sprite('vrmaef440_21', 4)	# 5-8
    sprite('vrmaef440_22', 10)	# 9-18
...
def maef_440_slash4():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown4009(2)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef440_30', 4)	# 1-4
    sprite('vrmaef440_31', 4)	# 5-8
...
def maef_440_slash5():
    ...
    def upon_IMMEDIATE():
        Unknown4007(2)
        callSubroutine('Zanzou_Color')
    sprite('vrmaef440_40', 4)	# 1-4
    sprite('vrmaef440_41', 10)	# 5-14
...
def maef_601():
    ...
    def upon_IMMEDIATE():
        ...
        Unknown1007(704000)
    sprite('null', 30)	# 1-30
    sprite('maef601_00', 2)	# 31-32
    physicsYImpulse(-64000)
    GFX_0('maef_601_dust', -1)
    sprite('maef601_00', 2)	# 33-34
    GFX_0('maef_601_dust', -1)
    sprite('maef601_00', 2)	# 35-36
    GFX_0('maef_601_dust', -1)
    sprite('maef601_00', 2)	# 37-38
    GFX_0('maef_601_dust', -1)
    sprite('maef601_00', 2)	# 39-40
    GFX_0('maef_601_dust', -1)
