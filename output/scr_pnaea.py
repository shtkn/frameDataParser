...
def PNA_PersonaJC():
    ...
    sprite('su255_09', 4)	# 63-66
    SFX_3('cloth_l')
    sprite('su255_07', 4)	# 67-70
    sprite('su255_08', 4)	# 71-74
    sprite('su255_09', 4)	# 75-78
    SFX_3('cloth_l')
    sprite('su255_07', 4)	# 79-82
    sprite('su255_08', 4)	# 83-86
...
def PBC_PersonaUltimateMUDOON():
    ...
    sprite('su432_07', 1)	# 11-11
    GFX_0('Mudoon_search', 100)
    sprite('su432_07', 3)	# 12-14
    sprite('su432_08', 1)	# 15-15
    GFX_0('Mudoon', 100)
    sprite('su432_08', 3)	# 16-18
